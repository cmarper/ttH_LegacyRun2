...
void convert_tree(
  ...
  if(sample=="sync16"){
    ...
    file="sync_ntuple_converted_ttHNonbb_2016_v19_50k";
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/2016/";
    list.push_back("/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_LLRHtautau/2016/sync_ntuple_LLRHtautau_ttHNonbb_2016_v12_50k.root");

  }

  else if(sample=="sync17"){

    file="sync_ntuple_converted_ttHNonbb_2017_v14";
    ...
    file="sync_ntuple_converted_ttHNonbb_2018_v13";
