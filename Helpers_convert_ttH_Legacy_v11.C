...
void convert_tree(
  ...
  if(sample=="sync16"){
    ...
    file="sync_ntuple_converted_ttHNonbb_2016_v20";
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/2016/";
    list.push_back("/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_LLRHtautau/2016/sync_ntuple_LLRHtautau_ttHNonbb_2016_v12.root");

  }

  else if(sample=="sync17"){

    file="sync_ntuple_converted_ttHNonbb_2017_v15";
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/2017/";
    list.push_back("/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_LLRHtautau/2017/sync_ntuple_LLRHtautau_ttHNonbb_2017_v8.root");

  }

  else if(sample=="sync18"){

    file="sync_ntuple_converted_ttHNonbb_2018_v14";
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/2018/";
    list.push_back("/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_LLRHtautau/2018/sync_ntuple_LLRHtautau_ttHNonbb_2018_v7.root");
  ...
  */
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    for(unsigned int i_ele=0; i_ele<reco_eles.size(); i_ele++){
      ...
      /*if(_EventNumber==11501592){
        cout<<"lepMVA_pt "<<lepMVA_pt<<endl;
        cout<<"lepMVA_eta "<<lepMVA_eta<<endl;
        cout<<"lepMVA_jetNDauChargedMVASel "<<lepMVA_jetNDauChargedMVASel<<endl;
        cout<<"lepMVA_miniRelIsoCharged "<<lepMVA_miniRelIsoCharged<<endl;
        cout<<"lepMVA_miniRelIsoNeutral "<<lepMVA_miniRelIsoNeutral<<endl;
        cout<<"lepMVA_jetPtRel "<<lepMVA_jetPtRel<<endl;
        cout<<"lepMVA_jetPtRatio "<<lepMVA_jetPtRatio<<endl;
        cout<<"lepMVA_jetDF "<<lepMVA_jetDF<<endl;
        cout<<"lepMVA_sip3d "<<lepMVA_sip3d<<endl;
        cout<<"lepMVA_dxy "<<lepMVA_dxy<<endl;
        cout<<"lepMVA_dz "<<lepMVA_dz<<endl;
        cout<<"lepMVA_Id "<<lepMVA_Id<<endl;
      }*/
      ...
      if(_EventNumber==11501592) cout<<"leptonMVA_ "<<leptonMVA_<<endl;
