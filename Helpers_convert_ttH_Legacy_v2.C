...
void convert_tree(
  ...
  if(sample=="sync16"){
    ...
    file="sync_ntuple_converted_ttHNonbb_2016_v3";
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/";
    list.push_back("/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_LLRHtautau/sync_ntuple_LLRHtautau_ttHNonbb_2016_v3.root");
  ...
  */
  ...
  TMVA::Reader* mu_reader_2016  = BookLeptonMVAReader2016("lepMVA_weights", "mu_BDTG.weights.xml", "mu");
  TMVA::Reader* ele_reader_2016 = BookLeptonMVAReader2016("lepMVA_weights", "el_BDTG.weights.xml", "ele");
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    for(unsigned int i_mu=0; i_mu<reco_mus.size(); i_mu++){
      ...
      if(year==2017 || year == 2018){
        ...
        lepMVA_jetPtRel   = _recomu_jetPtRel[i_mu]; 
      ...
      if( fabs(PDGId)==11 ){
        ...
        int eleMissingLostHits = (*_daughters_eleMissingLostHits)[i_daughter];
          ...
          if (year==2017 || year==2018){
            ...
            lepMVA_miniRelIsoCharged = miniRelIsoCharged;
            lepMVA_miniRelIsoNeutral = miniRelIsoNeutral; 
            lepMVA_jetPtRel   = (*_daughters_jetPtRel)[i_daughter]; 
    ...
    for(unsigned int i_ele=0; i_ele<reco_eles.size(); i_ele++){
      ...
      if(year==2017 || year == 2018){
        ...
        lepMVA_jetPtRel   = _recoele_jetPtRel[i_ele]; 
