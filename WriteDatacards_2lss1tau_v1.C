...
int main(int argc, char** argv) {
  ...
  config.add_options()
    ("input_file,i", po::value<string>(&input_file)->default_value("datacard_nrecotauh_2lss1tau_2016.root"))
    ("output_file,o", po::value<string>(&output_file)->default_value("ttH_2lss1tau_nrecotauh_2016.root"))
