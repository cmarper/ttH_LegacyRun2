...
void add_BDT(TString filein, TString fileout, vector<TString> treename){
  ...
  for(unsigned int i_tree=0;i_tree<treename.size();i_tree++){
    ...
    for(int i=0;i<nentries;i++){
      ...
      if(_category==2110 || _category==2120 || _category==3010 || _category==3020 || _category==3030){
...
void test16(){
  ...
  TString filein="/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_splitted/2016/sync_ntuple_splitted_ttHNonbb_2016_v14.root";
