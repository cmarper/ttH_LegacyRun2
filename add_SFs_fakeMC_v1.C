...
void loadsample(TString sample, int year, TString type, bool ismc){
    ...
    TString year_s = std::to_string(year);
  	...
  	TString filein;
    filein = "/data_CMS/cms/mperez/ttH_Legacy/Oct19/ntuples_splitted_MEM/"+year_s+"/nominal/"+type+"/ntuple_"+sample+"_MEM_fake.root";

    TString fileout;
    fileout = "/data_CMPerez/mperez/ttH_Legacy/ntuples_datacards/"+year_s+"/nominal/"+type+"/ntuple_"+sample+"_MEM_fake_SF_v4.root";
...
void test_fake_2016(){
    ...
    //loadsample("Oct19v1_MC_2016_ttH_ctcvcp",2016,"ttH",true); --> DONE
