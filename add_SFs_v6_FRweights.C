...
void add_SFs(TString filein, TString fileout, vector<TString> treename, bool isMC, int year){
  	...
  	*/
      ...
      float _event_weight_ttH_v3;

      float _event_weight_ttH_ele_up_v3;
      float _event_weight_ttH_ele_down_v3;
      float _event_weight_ttH_ele_pt1_v3;
      float _event_weight_ttH_ele_pt2_v3;
      float _event_weight_ttH_ele_be1_v3;
      float _event_weight_ttH_ele_be2_v3;

      float _event_weight_ttH_mu_up_v3;
      float _event_weight_ttH_mu_down_v3;
      float _event_weight_ttH_mu_pt1_v3;
      float _event_weight_ttH_mu_pt2_v3;
      float _event_weight_ttH_mu_be1_v3;
      float _event_weight_ttH_mu_be2_v3;

      float _event_weight_ttH_FR_QCD_MC_v3;
      float _event_weight_ttH_FR_TT_MC_v3;
      float _event_weight_ttH_ele_FR_QCD_MC_v3;
      float _event_weight_ttH_ele_FR_TT_MC_v3;
      float _event_weight_ttH_mu_FR_QCD_MC_v3;
      float _event_weight_ttH_mu_FR_TT_MC_v3;

      tree_new->Branch("event_weight_ttH_v3",&_event_weight_ttH_v3,"event_weight_ttH_v3/F");

      tree_new->Branch("event_weight_ttH_ele_up_v3",&_event_weight_ttH_ele_up_v3,"event_weight_ttH_ele_up_v3/F");
      tree_new->Branch("event_weight_ttH_ele_down_v3",&_event_weight_ttH_ele_down_v3,"event_weight_ttH_ele_down_v3/F");
      tree_new->Branch("event_weight_ttH_ele_pt1_v3",&_event_weight_ttH_ele_pt1_v3,"event_weight_ttH_ele_pt1_v3/F");
      tree_new->Branch("event_weight_ttH_ele_pt2_v3",&_event_weight_ttH_ele_pt2_v3,"event_weight_ttH_ele_pt2_v3/F");
      tree_new->Branch("event_weight_ttH_ele_be1_v3",&_event_weight_ttH_ele_be1_v3,"event_weight_ttH_ele_be1_v3/F");
      tree_new->Branch("event_weight_ttH_ele_be2_v3",&_event_weight_ttH_ele_be2_v3,"event_weight_ttH_ele_be2_v3/F");

      tree_new->Branch("event_weight_ttH_mu_up_v3",&_event_weight_ttH_mu_up_v3,"event_weight_ttH_mu_up_v3/F");
      tree_new->Branch("event_weight_ttH_mu_down_v3",&_event_weight_ttH_mu_down_v3,"event_weight_ttH_mu_down_v3/F");
      tree_new->Branch("event_weight_ttH_mu_pt1_v3",&_event_weight_ttH_mu_pt1_v3,"event_weight_ttH_mu_pt1_v3/F");
      tree_new->Branch("event_weight_ttH_mu_pt2_v3",&_event_weight_ttH_mu_pt2_v3,"event_weight_ttH_mu_pt2_v3/F");
      tree_new->Branch("event_weight_ttH_mu_be1_v3",&_event_weight_ttH_mu_be1_v3,"event_weight_ttH_mu_be1_v3/F");
      tree_new->Branch("event_weight_ttH_mu_be2_v3",&_event_weight_ttH_mu_be2_v3,"event_weight_ttH_mu_be2_v3/F");

      tree_new->Branch("event_weight_ttH_FR_QCD_MC_v3",&_event_weight_ttH_FR_QCD_MC_v3,"event_weight_ttH_FR_QCD_MC_v3/F");
      tree_new->Branch("event_weight_ttH_FR_TT_MC_v3",&_event_weight_ttH_FR_TT_MC_v3,"event_weight_ttH_FR_TT_MC_v3/F");
      tree_new->Branch("event_weight_ttH_ele_FR_QCD_MC_v3",&_event_weight_ttH_ele_FR_QCD_MC_v3,"event_weight_ttH_ele_FR_QCD_MC_v3/F");
      tree_new->Branch("event_weight_ttH_ele_FR_TT_MC_v3",&_event_weight_ttH_ele_FR_TT_MC_v3,"event_weight_ttH_ele_FR_TT_MC_v3/F");
      tree_new->Branch("event_weight_ttH_mu_FR_QCD_MC_v3",&_event_weight_ttH_mu_FR_QCD_MC_v3,"event_weight_ttH_mu_FR_QCD_MC_v3/F");
      tree_new->Branch("event_weight_ttH_mu_FR_TT_MC_v3",&_event_weight_ttH_mu_FR_TT_MC_v3,"event_weight_ttH_mu_FR_TT_MC_v3/F");
        ...
        _event_weight_ttH_v3 = 0;

        _event_weight_ttH_ele_up_v3 = 0;
        _event_weight_ttH_ele_down_v3 = 0;
        _event_weight_ttH_ele_pt1_v3 = 0;
        _event_weight_ttH_ele_pt2_v3 = 0;
        _event_weight_ttH_ele_be1_v3 = 0;
        _event_weight_ttH_ele_be2_v3 = 0;

        _event_weight_ttH_mu_up_v3 = 0;
        _event_weight_ttH_mu_down_v3 = 0;
        _event_weight_ttH_mu_pt1_v3 = 0;
        _event_weight_ttH_mu_pt2_v3 = 0;
        _event_weight_ttH_mu_be1_v3 = 0;
        _event_weight_ttH_mu_be2_v3 = 0;

        _event_weight_ttH_FR_QCD_MC_v3 = 0;
        _event_weight_ttH_FR_TT_MC_v3 = 0;
        _event_weight_ttH_ele_FR_QCD_MC_v3 = 0;
        _event_weight_ttH_ele_FR_TT_MC_v3 = 0;
        _event_weight_ttH_mu_FR_QCD_MC_v3 = 0;
        _event_weight_ttH_mu_FR_TT_MC_v3 = 0;

      	tree->GetEntry(i);

        if(i==(nentries-1)) cout<<"FINISHED!!!"<<endl;

        _event_weight_ttH_v3 = 1.;

        _event_weight_ttH_ele_up_v3 = 1.;
        _event_weight_ttH_ele_down_v3 = 1.;
        _event_weight_ttH_ele_pt1_v3 = 1.;
        _event_weight_ttH_ele_pt2_v3 = 1.;
        _event_weight_ttH_ele_be1_v3 = 1.;
        _event_weight_ttH_ele_be2_v3 = 1.;

        _event_weight_ttH_mu_up_v3 = 1.;
        _event_weight_ttH_mu_down_v3 = 1.;
        _event_weight_ttH_mu_pt1_v3 = 1.;
        _event_weight_ttH_mu_pt2_v3 = 1.;
        _event_weight_ttH_mu_be1_v3 = 1.;
        _event_weight_ttH_mu_be2_v3 = 1.;

        _event_weight_ttH_FR_QCD_MC_v3 = 1.;
        _event_weight_ttH_FR_TT_MC_v3 = 1.;
        _event_weight_ttH_ele_FR_QCD_MC_v3 = 1.;
        _event_weight_ttH_ele_FR_TT_MC_v3 = 1.;
        _event_weight_ttH_mu_FR_QCD_MC_v3 = 1.;
        _event_weight_ttH_mu_FR_TT_MC_v3 = 1.;
        ...
        if( _category == 3120 ){ // 1 tau WP Vloose, 2 leptons
            ...
            if(!(*_recotauh_sel_byVLooseDeepTau2017v2p1VSjet)[0]){
                ...
                _event_weight_ttH_v3 *= fakerate_nominal/(1-fakerate_nominal);

                _event_weight_ttH_FR_QCD_MC_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_FR_TT_MC_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_FR_QCD_MC_v3  *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_FR_TT_MC_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_FR_QCD_MC_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_FR_TT_MC_v3 *= fakerate_nominal/(1-fakerate_nominal);

                _event_weight_ttH_ele_up_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_down_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_pt1_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_pt2_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_be1_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_ele_be2_v3 *= fakerate_nominal/(1-fakerate_nominal);

                _event_weight_ttH_mu_up_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_down_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_pt1_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_pt2_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_be1_v3 *= fakerate_nominal/(1-fakerate_nominal);
                _event_weight_ttH_mu_be2_v3 *= fakerate_nominal/(1-fakerate_nominal);
            ...
            if(!(*_recolep_sel_ismvasel)[0]){
                ...
                if(fabs((*_recolep_sel_pdg)[0])==11){
                    ...
                    float correction = 1.;
                    if(_year==2016) correction = 1.376;
                    else if(_year==2017) correction = 1.252;
                    else if(_year==2018) correction = 1.325;

                    _event_weight_ttH_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);

                    _event_weight_ttH_FR_QCD_MC_v3 *= correction*fakerate_QCD/(1-fakerate_QCD);
                    _event_weight_ttH_FR_TT_MC_v3 *= correction*fakerate_TT/(1-fakerate_TT);
                    _event_weight_ttH_ele_FR_QCD_MC_v3  *= correction*fakerate_QCD/(1-fakerate_QCD);
                    _event_weight_ttH_ele_FR_TT_MC_v3 *= correction*fakerate_TT/(1-fakerate_TT);
                    _event_weight_ttH_mu_FR_QCD_MC_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_FR_TT_MC_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);

                    _event_weight_ttH_ele_up_v3 *= correction*fakerate_up/(1-fakerate_up);
                    _event_weight_ttH_ele_down_v3 *= correction*fakerate_down/(1-fakerate_down);
                    _event_weight_ttH_ele_pt1_v3 *= correction*fakerate_pt1/(1-fakerate_pt1);
                    _event_weight_ttH_ele_pt2_v3 *= correction*fakerate_pt2/(1-fakerate_pt2);
                    _event_weight_ttH_ele_be1_v3 *= correction*fakerate_be1/(1-fakerate_be1);
                    _event_weight_ttH_ele_be2_v3 *= correction*fakerate_be2/(1-fakerate_be2);

                    _event_weight_ttH_mu_up_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_down_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_pt1_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_pt2_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_be1_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_be2_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    ...
                    float correction = 1.;
                    if(_year==2016) correction = 1.050;
                    else if(_year==2017) correction = 1.157;
                    else if(_year==2018) correction = 1.067;

                    _event_weight_ttH_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);

                    _event_weight_ttH_FR_QCD_MC_v3 *= correction*fakerate_QCD/(1-fakerate_QCD);
                    _event_weight_ttH_FR_TT_MC_v3 *= correction*fakerate_TT/(1-fakerate_TT);
                    _event_weight_ttH_ele_FR_QCD_MC_v3  *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_ele_FR_TT_MC_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_mu_FR_QCD_MC_v3 *= correction*fakerate_QCD/(1-fakerate_QCD);
                    _event_weight_ttH_mu_FR_TT_MC_v3 *= correction*fakerate_TT/(1-fakerate_TT);

                    _event_weight_ttH_ele_up_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_ele_down_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_ele_pt1_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_ele_pt2_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_ele_be1_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);
                    _event_weight_ttH_ele_be2_v3 *= correction*fakerate_nominal/(1-fakerate_nominal);

                    _event_weight_ttH_mu_up_v3 *= correction*fakerate_up/(1-fakerate_up);
                    _event_weight_ttH_mu_down_v3 *= correction*fakerate_down/(1-fakerate_down);
                    _event_weight_ttH_mu_pt1_v3 *= correction*fakerate_pt1/(1-fakerate_pt1);
                    _event_weight_ttH_mu_pt2_v3 *= correction*fakerate_pt2/(1-fakerate_pt2);
                    _event_weight_ttH_mu_be1_v3 *= correction*fakerate_be1/(1-fakerate_be1);
                    _event_weight_ttH_mu_be2_v3 *= correction*fakerate_be2/(1-fakerate_be2); 
...
void loadsample(TString sample, int year, TString type, bool ismc){
    ...
    if(!ismc){
      filein = "/data_CMPerez/mperez/ttH_Legacy/ntuples_datacards/"+year_s+"/nominal/"+type+"/fake/ntuple_"+sample+"_MEM_fake_SF_v2_noOverlap.root";
      fileout = "/data_CMPerez/mperez/ttH_Legacy/ntuples_datacards/"+year_s+"/nominal/"+type+"/fake/ntuple_"+sample+"_MEM_fake_SF_v3_noOverlap.root";
    }

    else if(ismc){
      filein = "/data_CMPerez/mperez/ttH_Legacy/ntuples_datacards/"+year_s+"/nominal/"+type+"/ntuple_"+sample+"_MEM_fake_SF_v4.root";
      fileout = "/data_CMPerez/mperez/ttH_Legacy/ntuples_datacards/"+year_s+"/nominal/"+type+"/ntuple_"+sample+"_MEM_fake_SF_v5.root";
    }
...
void test_data_2016(){
    ...
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockB",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockC",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockD",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockE",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockF",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockG",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleElectron_BlockH",2016,"Data",false);

    loadsample("Oct19v1_Data_2016_SingleMuon_BlockB",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleMuon_BlockC",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleMuon_BlockD",2016,"Data",false); 
    loadsample("Oct19v1_Data_2016_SingleMuon_BlockE",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleMuon_BlockF",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleMuon_BlockG",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_SingleMuon_BlockH",2016,"Data",false);

    loadsample("Oct19v1_Data_2016_DoubleEG_BlockB",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleEG_BlockC",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleEG_BlockD",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleEG_BlockE",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleEG_BlockF",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleEG_BlockG",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleEG_BlockH",2016,"Data",false);

    loadsample("Oct19v1_Data_2016_DoubleMu_BlockB",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleMu_BlockC",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleMu_BlockD",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleMu_BlockE",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleMu_BlockF",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleMu_BlockG",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_DoubleMu_BlockH",2016,"Data",false);

    loadsample("Oct19v1_Data_2016_MuonEG_BlockB",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_MuonEG_BlockC",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_MuonEG_BlockD",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_MuonEG_BlockE",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_MuonEG_BlockF",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_MuonEG_BlockG",2016,"Data",false);
    loadsample("Oct19v1_Data_2016_MuonEG_BlockH",2016,"Data",false);

}

void test_data_2017(){

    loadsample("Oct19v1_Data_2017_SingleElectron_BlockB",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleElectron_BlockC",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleElectron_BlockD",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleElectron_BlockE",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleElectron_BlockF",2017,"Data",false);

    loadsample("Oct19v1_Data_2017_SingleMuon_BlockB",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleMuon_BlockC",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleMuon_BlockD",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleMuon_BlockE",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_SingleMuon_BlockF",2017,"Data",false);

    loadsample("Oct19v1_Data_2017_DoubleEG_BlockB",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleEG_BlockC",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleEG_BlockD",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleEG_BlockE",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleEG_BlockF",2017,"Data",false);

    loadsample("Oct19v1_Data_2017_DoubleMu_BlockB",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleMu_BlockC",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleMu_BlockD",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleMu_BlockE",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_DoubleMu_BlockF",2017,"Data",false);

    loadsample("Oct19v1_Data_2017_MuonEG_BlockB",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_MuonEG_BlockC",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_MuonEG_BlockD",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_MuonEG_BlockE",2017,"Data",false);
    loadsample("Oct19v1_Data_2017_MuonEG_BlockF",2017,"Data",false);
...
void test_data_2018(){
    ...
    loadsample("Oct19v1_Data_2018_EGamma_BlockA",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_EGamma_BlockB",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_EGamma_BlockC",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_EGamma_BlockD",2018,"Data",false);

    loadsample("Oct19v1_Data_2018_SingleMuon_BlockA",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_SingleMuon_BlockB",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_SingleMuon_BlockC",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_SingleMuon_BlockD",2018,"Data",false);

    loadsample("Oct19v1_Data_2018_DoubleMu_BlockA",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_DoubleMu_BlockB",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_DoubleMu_BlockC",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_DoubleMu_BlockD",2018,"Data",false);

    loadsample("Oct19v1_Data_2018_MuonEG_BlockA",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_MuonEG_BlockB",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_MuonEG_BlockC",2018,"Data",false);
    loadsample("Oct19v1_Data_2018_MuonEG_BlockD",2018,"Data",false);
