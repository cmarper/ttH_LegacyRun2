...
void compareSyncNtuples()
{
  ...
  std::string inputFileName_ref = "sync_ntuple_objects_syncformat_ttHNonbb_2016_v1.root";
  ...
  std::string inputFileName_test = "IHEP_ttHsyncV1.root"; 
  ...
  std::string outputFilePath = "../plots_sync/objects_LLRv1_IHEPv1";
