...
void compareSyncNtuples()
{
  ...
  std::string inputFileName_ref = "sync_ntuple_objects_syncformat_ttHNonbb_2016_v17.root";
  ...
  std::string inputFileName_test = "sync_Tallinn_2016_v23.root"; 
