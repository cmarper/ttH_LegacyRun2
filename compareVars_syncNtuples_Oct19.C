...
struct branchEntryType
{
  ...
  void fillHistogram(TTree* tree, const std::string& selection)
  {
    ...
    tree->Draw(drawCommand.data(), selection_full.data(), "goff");
...
void compareSyncNtuples()
{
  ...
  std::string inputFileName_ref = "sync_ntuple_objects_syncformat_ttHNonbb_2016_Oct19_v4.root";
  ...
  std::string inputFileName_test = "sync_Tallinn_2016_v32_deep.root"; 
  std::string legendEntry_test = "Tallinn";
  TFile* inputFile_test = openFile(inputFilePath_test, inputFileName_test);
  std::string treeName_test = "syncTree";
  TTree* tree_test = loadTree(inputFile_test, treeName_test);
  std::string selection_test = "n_presel_jet >= 1";

  std::string outputFilePath = "../plots_sync/2016/plots2016/Oct19/";
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_jetPtRatio", "F", "n_presel_mu >= 1", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("mu1_leptonMVA", "F", "n_presel_mu >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu1_jetCSV", "F", "n_presel_mu >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu1_jetDeepCSV", "F", "n_presel_mu >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu1_jetDeepJet", "F", "n_presel_mu >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu1_segmentCompatibility", "F", "n_presel_mu >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu1_phi", "F", "n_presel_mu >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("mu1_sip3D", "F", "n_presel_mu >= 1", 100, -5., +15.));
  branchesToCompare.push_back(new branchEntryType("mu1_pt", "F", "n_presel_mu >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mu1_conept", "F", "n_presel_mu >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mu1_miniRelIso", "F", "n_presel_mu >= 1", 100, -0.01, 0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_dz", "F", "n_presel_mu >= 1", 100, -0.4, +0.4));
  branchesToCompare.push_back(new branchEntryType("mu1_PFRelIso04", "F", "n_presel_mu >= 1", 100, -1., +1.));
  
  branchesToCompare.push_back(new branchEntryType("mu1_isGenMatched", "F", "n_presel_mu >= 1", 2, -0.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu2_jetPtRatio", "F", "n_presel_mu >= 2", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("mu2_leptonMVA", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu2_jetCSV", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu2_jetDeepCSV", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu2_jetDeepJet", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu2_segmentCompatibility", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("mu2_phi", "F", "n_presel_mu >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("mu2_sip3D", "F", "n_presel_mu >= 2", 100, -5., +15.));
  branchesToCompare.push_back(new branchEntryType("mu2_pt", "F", "n_presel_mu >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mu2_conept", "F", "n_presel_mu >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("mu2_miniRelIso", "F", "n_presel_mu >= 2", 100, -0.01, 0.5));
  ...
  branchesToCompare.push_back(new branchEntryType("mu2_dz", "F", "n_presel_mu >= 2", 100, -0.4, +0.4));
  branchesToCompare.push_back(new branchEntryType("mu2_PFRelIso04", "F", "n_presel_mu >= 1", 100, -1., +1.));
  branchesToCompare.push_back(new branchEntryType("mu2_isGenMatched", "F", "n_presel_mu >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_ntMVAeleID", "F", "n_presel_ele >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_charge", "F", "n_presel_ele >= 1", 3, -1.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_jetPtRatio", "F", "n_presel_ele >= 1", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("ele1_leptonMVA", "F", "n_presel_ele >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_jetCSV", "F", "n_presel_ele >= 1", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_jetDeepCSV", "F", "n_presel_mu >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_jetDeepJet", "F", "n_presel_mu >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_phi", "F", "n_presel_ele >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ele1_sip3D", "F", "n_presel_ele >= 1", 100, -5., +15.));
  branchesToCompare.push_back(new branchEntryType("ele1_pt", "F", "n_presel_ele >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ele1_conept", "F", "n_presel_ele >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ele1_miniRelIso", "F", "n_presel_ele >= 1", 100, -0.01, 0.5));
  branchesToCompare.push_back(new branchEntryType("ele1_dxyAbs", "F", "n_presel_ele >= 1", 100, -0.02, +0.08));
  branchesToCompare.push_back(new branchEntryType("ele1_eta", "F", "n_presel_ele >= 1", 100, -3.0, +3.0));
  branchesToCompare.push_back(new branchEntryType("ele1_dz", "F", "n_presel_ele >= 1", 100, -0.4, +0.4));
  branchesToCompare.push_back(new branchEntryType("ele1_PFRelIso04", "F", "n_presel_ele >= 1", 100, -1., +1.));
  branchesToCompare.push_back(new branchEntryType("ele1_isGenMatched", "F", "n_presel_ele >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_ntMVAeleID", "F", "n_presel_ele >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_charge", "F", "n_presel_ele >= 2", 3, -1.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("ele2_jetPtRatio", "F", "n_presel_ele >= 2", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("ele2_leptonMVA", "F", "n_presel_ele >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_jetCSV", "F", "n_presel_ele >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_jetDeepCSV", "F", "n_presel_mu >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_jetDeepJet", "F", "n_presel_mu >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_phi", "F", "n_presel_ele >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ele2_sip3D", "F", "n_presel_ele >= 2", 100, -5., +15.));
  branchesToCompare.push_back(new branchEntryType("ele2_pt", "F", "n_presel_ele >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ele2_conept", "F", "n_presel_ele >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ele2_miniRelIso", "F", "n_presel_ele >= 2", 100, -0.01, 0.5));
  branchesToCompare.push_back(new branchEntryType("ele2_dxyAbs", "F", "n_presel_ele >= 2", 100, -0.02, +0.08));
  ...
  branchesToCompare.push_back(new branchEntryType("ele2_PFRelIso04", "F", "n_presel_ele >= 1", 100, -1., +1.));
  branchesToCompare.push_back(new branchEntryType("ele2_isGenMatched", "F", "n_presel_ele >= 1", 2, -0.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("tau1_byVVVLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byVVLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byVLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byMediumDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byTightDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byVTightDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byVVTightDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byDeepTau2017v2VSeraw","F","n_presel_tau >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byVLooseDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byLooseDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byMediumDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byTightDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau1_byDeepTau2017v2VSmuraw","F","n_presel_tau >= 1", 100, -1.5, +1.5)); 
  ...
  branchesToCompare.push_back(new branchEntryType("tau1_isGenMatched", "F", "n_presel_tau >= 1", 2, -0.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("tau2_byDeepTau2017v2VSjetraw","F","n_presel_tau >= 1", 100, -1.5, +1.5));
    branchesToCompare.push_back(new branchEntryType("tau2_byVVVLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byVVLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byVLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byLooseDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byMediumDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byTightDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byVTightDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byVVTightDeepTau2017v2VSe","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byDeepTau2017v2VSeraw","F","n_presel_tau >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byVLooseDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byLooseDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byMediumDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byTightDeepTau2017v2VSmu","I","n_presel_tau >= 1", 2, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("tau2_byDeepTau2017v2VSmuraw","F","n_presel_tau >= 1", 100, -1.5, +1.5));

  branchesToCompare.push_back(new branchEntryType("tau2_isGenMatched", "F", "n_presel_tau >= 1", 2, -0.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet1_eta", "F", "n_presel_jet >= 1", 100, -5.5, +5.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet1_QGdiscr", "F", "n_presel_jet >= 1", 100, -0.2, +1.2));  

  branchesToCompare.push_back(new branchEntryType("jet2_CSV", "F", "n_presel_jet >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet2_DeepCSV", "F", "n_presel_jet >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet2_DeepJet", "F", "n_presel_jet >= 2", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet2_pt", "F", "n_presel_jet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jet2_eta", "F", "n_presel_jet >= 2", 100, -5.5, +5.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet2_QGdiscr", "F", "n_presel_jet >= 1", 100, -0.2, +1.2));

  branchesToCompare.push_back(new branchEntryType("jet3_CSV", "F", "n_presel_jet >= 3", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet3_DeepCSV", "F", "n_presel_jet >= 3", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet3_DeepJet", "F", "n_presel_jet >= 3", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet3_pt", "F", "n_presel_jet >= 3", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jet3_eta", "F", "n_presel_jet >= 3", 100, -5.5, +5.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet3_QGdiscr", "F", "n_presel_jet >= 1", 100, -0.2, +1.2));

  branchesToCompare.push_back(new branchEntryType("jet4_CSV", "F", "n_presel_jet >= 4", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet4_DeepCSV", "F", "n_presel_jet >= 4", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet4_DeepJet", "F", "n_presel_jet >= 4", 100, -0.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet4_pt", "F", "n_presel_jet >= 4", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jet4_eta", "F", "n_presel_jet >= 4", 100, -5.5, +5.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet4_QGdiscr", "F", "n_presel_jet >= 1", 100, -0.2, +1.2));

  branchesToCompare.push_back(new branchEntryType("jetFwd1_pt", "F", "n_presel_jetFwd >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jetFwd1_eta", "F", "n_presel_jetFwd >= 1", 100, -5.5, +5.5));
  branchesToCompare.push_back(new branchEntryType("jetFwd1_phi", "F", "n_presel_jetFwd >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("jetFwd1_E", "F", "n_presel_jetFwd >= 1", 100, 0., 250.));
 
  branchesToCompare.push_back(new branchEntryType("jetFwd2_pt", "F", "n_presel_jetFwd >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jetFwd2_eta", "F", "n_presel_jetFwd >= 2", 100, -5.5, +5.5));
  branchesToCompare.push_back(new branchEntryType("jetFwd2_phi", "F", "n_presel_jetFwd >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("jetFwd2_E", "F", "n_presel_jetFwd >= 2", 100, 0., 250.));

  branchesToCompare.push_back(new branchEntryType("jetFwd3_pt", "F", "n_presel_jetFwd >= 3", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jetFwd3_eta", "F", "n_presel_jetFwd >= 3", 100, -5.5, +5.5));
  branchesToCompare.push_back(new branchEntryType("jetFwd3_phi", "F", "n_presel_jetFwd >= 3", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("jetFwd3_E", "F", "n_presel_jetFwd >= 3", 100, 0., 250.));

  branchesToCompare.push_back(new branchEntryType("jetFwd4_pt", "F", "n_presel_jetFwd >= 4", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("jetFwd4_eta", "F", "n_presel_jetFwd >= 4", 100, -5.5, +5.5));
  branchesToCompare.push_back(new branchEntryType("jetFwd4_phi", "F", "n_presel_jetFwd >= 4", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("jetFwd4_E", "F", "n_presel_jetFwd >= 4", 100, 0., 250.));
  ...
  for ( std::vector<branchEntryType*>::const_iterator branch = branchesToCompare.begin();
    ...
    branch_ref->fillHistogram(tree_ref, selection_ref);
    normalizeHistogram(branch_ref->histogram_);
    
    branchEntryType* branch_test = (*branch)->Clone("test");
    branch_test->fillHistogram(tree_test, selection_test);
    ...
    showHistograms(800, 900, 
		   branch_ref->histogram_, legendEntry_ref, 
		   branch_test->histogram_, legendEntry_test, 
		   NULL, "", 
		   NULL, "", 
		   NULL, "", 
		   NULL, "", 
