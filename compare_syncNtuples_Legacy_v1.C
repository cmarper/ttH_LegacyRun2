...
void compareSyncNtuples()
{
  ...
  //std::string inputFileName_ref = "sync_Tallinn_2016_v3.root";
  std::string inputFilePath_ref = "/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_syncformat";
  std::string inputFileName_ref = "sync_ntuple_objects_syncformat_ttHNonbb_2016_v4.root";
  ...
  std::string inputFilePath_test = "/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_groups";
  //std::string inputFileName_test = "IHEP_ttHsyncV2.root"; 
  ...
  //std::string outputFilePath = "../plots_sync/objects_LLRv4_IHEPv2";
  //std::string outputFilePath = "../plots_sync/objects_LLRv4_Tallinnv3";
  //std::string outputFilePath = "../plots_sync/objects_IHEPv1_Tallinnv3";
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_jetPtRatio", "F", "n_presel_mu >= 1", 100, -0.01, 10.));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_sip3D", "F", "n_presel_mu >= 1", 100, -20., +20.));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_miniRelIso", "F", "n_presel_mu >= 1", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("mu1_dxy", "F", "n_presel_mu >= 1", 100, -0.1, +0.1));
  ...
  branchesToCompare.push_back(new branchEntryType("mu1_dz", "F", "n_presel_mu >= 1", 100, -1., +1.));
  ...
  branchesToCompare.push_back(new branchEntryType("mu2_jetPtRatio", "F", "n_presel_mu >= 2", 100, -0.01, 10.));
  ...
  branchesToCompare.push_back(new branchEntryType("mu2_sip3D", "F", "n_presel_mu >= 2", 100, -20., +20.));
  ...
  branchesToCompare.push_back(new branchEntryType("mu2_miniRelIso", "F", "n_presel_mu >= 2", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("mu2_dxyAbs", "F", "n_presel_mu >= 2", 100, -0.1, +0.1));
  branchesToCompare.push_back(new branchEntryType("mu2_dxy", "F", "n_presel_mu >= 2", 100, -0.1, +0.1));
  branchesToCompare.push_back(new branchEntryType("mu2_eta", "F", "n_presel_mu >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("mu2_dz", "F", "n_presel_mu >= 2", 100, -1., +1.));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_jetPtRatio", "F", "n_presel_ele >= 1", 100, -0.01, 10.));
  branchesToCompare.push_back(new branchEntryType("ele1_leptonMVA", "F", "n_presel_ele >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_jetCSV", "F", "n_presel_ele >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_jetDeepCSV", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_jetDeepJet", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele1_phi", "F", "n_presel_ele >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ele1_sip3D", "F", "n_presel_ele >= 1", 100, -20., +20.));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_miniRelIso", "F", "n_presel_ele >= 1", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("ele1_dxyAbs", "F", "n_presel_ele >= 1", 100, -0.1, +0.1));
  branchesToCompare.push_back(new branchEntryType("ele1_dxy", "F", "n_presel_ele >= 1", 100, -0.1, +0.1));
  branchesToCompare.push_back(new branchEntryType("ele1_eta", "F", "n_presel_ele >= 1", 100, -3.0, +3.0));
  branchesToCompare.push_back(new branchEntryType("ele1_dz", "F", "n_presel_ele >= 1", 100, -1., +1.));
  branchesToCompare.push_back(new branchEntryType("ele1_PFRelIso04", "F", "n_presel_mu >= 1", 100, -1., +1.));
  ...
  branchesToCompare.push_back(new branchEntryType("ele2_jetPtRatio", "F", "n_presel_ele >= 2", 100, -0.01, 10.));
  branchesToCompare.push_back(new branchEntryType("ele2_leptonMVA", "F", "n_presel_ele >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_jetCSV", "F", "n_presel_ele >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_jetDeepCSV", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_jetDeepJet", "F", "n_presel_mu >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("ele2_phi", "F", "n_presel_ele >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ele2_sip3D", "F", "n_presel_ele >= 2", 100, -20., +20.));
  ...
  branchesToCompare.push_back(new branchEntryType("ele2_miniRelIso", "F", "n_presel_ele >= 2", 100, -0.01, 2.));
  branchesToCompare.push_back(new branchEntryType("ele2_dxyAbs", "F", "n_presel_ele >= 2", 100, -0.1, +0.1));
  branchesToCompare.push_back(new branchEntryType("ele2_dxy", "F", "n_presel_ele >= 2", 100, -0.1, +0.1));
  branchesToCompare.push_back(new branchEntryType("ele2_eta", "F", "n_presel_ele >= 2", 100, -3.0, +3.0));
  branchesToCompare.push_back(new branchEntryType("ele2_dz", "F", "n_presel_ele >= 2", 100, -1., +1.));
  ...
  branchesToCompare.push_back(new branchEntryType("tau1_byCombinedIsolationDeltaBetaCorr3Hits", "F", "n_presel_tau >= 1", 100, -0.01, 100.));
  branchesToCompare.push_back(new branchEntryType("tau1_dz", "F", "n_presel_tau >= 1", 100, -2., +2.));
  ...
  branchesToCompare.push_back(new branchEntryType("tau2_byCombinedIsolationDeltaBetaCorr3Hits", "F", "n_presel_tau >= 2", 100, -0.01, 100.));
  branchesToCompare.push_back(new branchEntryType("tau2_dz", "F", "n_presel_tau >= 2", 100, -2., +2.));
  ...
  branchesToCompare.push_back(new branchEntryType("jet1_CSV", "F", "n_presel_jet >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet1_DeepCSV", "F", "n_presel_jet >= 1", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet1_DeepJet", "F", "n_presel_jet >= 1", 100, -1.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet1_QGdiscr", "F", "n_presel_jet >= 1", 100, -1., +1.));  

  branchesToCompare.push_back(new branchEntryType("jet2_CSV", "F", "n_presel_jet >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet2_DeepCSV", "F", "n_presel_jet >= 2", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet2_DeepJet", "F", "n_presel_jet >= 2", 100, -1.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet2_QGdiscr", "F", "n_presel_jet >= 1", 100, -1., +1.));

  branchesToCompare.push_back(new branchEntryType("jet3_CSV", "F", "n_presel_jet >= 3", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet3_DeepCSV", "F", "n_presel_jet >= 3", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet3_DeepJet", "F", "n_presel_jet >= 3", 100, -1.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet3_QGdiscr", "F", "n_presel_jet >= 1", 100, -1., +1.));

  branchesToCompare.push_back(new branchEntryType("jet4_CSV", "F", "n_presel_jet >= 4", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet4_DeepCSV", "F", "n_presel_jet >= 4", 100, -1.5, +1.5));
  branchesToCompare.push_back(new branchEntryType("jet4_DeepJet", "F", "n_presel_jet >= 4", 100, -1.5, +1.5));
  ...
  branchesToCompare.push_back(new branchEntryType("jet4_QGdiscr", "F", "n_presel_jet >= 1", 100, -1., +1.));
