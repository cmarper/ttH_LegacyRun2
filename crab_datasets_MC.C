...
std::tuple<TString, int, int, TString, bool> get_parameters( TString sample = "Oct19v1_MC_2016_ttHJetToNonbb" ){
  ...
  /*if( sample = "Oct19v1_MC_2016_ttHJetToNonbb" ) {  //0
    ...
    /*else if( sample = "Oct19v1_MC_2016_VBFHToBB" ) {  //36 - TO RESUBMIT!!!
	    dir_in = // ---> CHECK???
  	    nfiles = 90;
	    year = 2016; 
	    type = "qqH";
    ...
    /*else if( sample = "Oct19v1_MC_2017_ST_s-channel_PS" ) {  //11 -- TO RESUBMIT
	    dir_in = // --> CHECK!
  	    nfiles = 93;
	    year = 2017; 
	    type = "ttbar";
    ...
    /*else if( sample = "Oct19v1_MC_2017_ST_tW_top" ) {  //16 -- TO RESUBMIT
	    dir_in = // --> CHECK!
  	    nfiles = 139;
	    year = 2017; 
	    type = "ttbar";
    ...
    /*else if( sample = "Oct19v1_MC_2017_GluGluHToMuMu" ) {  //32 ---> TO RESUBMIT
	    dir_in = "MC_2017_Oct19/GluGluHToMuMu_M-125_TuneCP5_PSweights_13TeV_powheg_pythia8/Oct19v1_MC_2017_GluGluHToMuMu/191009_185042/";
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
