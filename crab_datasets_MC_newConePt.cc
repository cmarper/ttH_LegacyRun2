...
std::tuple<TString, int, int, int, TString, bool> get_parameters_MC( TString sample = "Oct19v1_MC_2016_ttHJetToNonbb" ){
    ...
    // t(t)H 
  	if( sample == "Oct19v1_MC_2016_ttHJetToNonbb" ) {  //0 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_THQ_ctcvcp" ) {  //1 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_THW_ctcvcp" ) {  //2 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ttH_ctcvcp" ) {  //3 - GOOD
    ...
    // TTV
    if( sample == "Oct19v1_MC_2016_TTZToLLNuNu_M-10_ext2" ) {  //4 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTZToLLNuNu_M-10_ext3" ) {  //5 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTZToLL_M-1to10" ) {  //6 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTWJetsToLNu" ) {  //7 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTWW" ) {  //8 - GOOD
    ...
    // TT 
    if( sample == "Oct19v1_MC_2016_ST_s-channel" ) {  //9 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ST_s-channel_PS" ) {  //10 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ST_t-channel_top" ) {  //11 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ST_t-channel_antitop" ) {  //12 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ST_t-channel_antitop_PS" ) {  //13 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ST_tW_top" ) {  //14 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ST_tW_antitop" ) {  //15 - GOOD
	    dir_in = "MC_2016_Oct19/ST_tW_antitop_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/Oct19v1_MC_2016_ST_tW_antitop/191009_142026/";
  	    nfiles = 58;
	    year = 2016; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_ST_tWll" ) {  //16 ---> GOOD (CHECK)
    ...
    if( sample == "Oct19v1_MC_2016_TTJets_DiLept_ext1" ) {  //17 ---> GOOD (CHECK)
    ...
    if( sample == "Oct19v1_MC_2016_TTJets_DiLept" ) {  //18 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_TTJets_SingleLeptFromT_ext1" ) {  //19 - GOOD
	    dir_in = "MC_2016_Oct19/TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/Oct19v2_MC_2016_TTJets_SingleLeptFromT_ext1/191107_130907/";
  	    nfiles = 316;
	    year = 2016; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_TTJets_SingleLeptFromT" ) {  //20 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTJets_SingleLeptFromTbar" ) {  //21 - GOOD
    ...
    if( sample == "Oct19v3_MC_2016_TTJets_SingleLeptFromTbar_ext1" ) {  //22
	    dir_in = "MC_2016_Oct19/TTJets_SingleLeptFromTbar_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/Oct19v3_MC_2016_TTJets_SingleLeptFromTbar_ext1/191120_074638/";
  	    nfiles = 366;
	    year = 2016; 
	    type = "ttbar";
	    isMC = true;
    ...
    if( sample == "Oct19v1_MC_2016_GluGluHToZZTo4L" ) {  //24 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluHToWWToLNuQQ" ) {  //25 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluHToWWTo2L2Nu" ) {  //26 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluHToMuMu" ) {  //27 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluHToBB" ) {  //28 - GOOD
    ...
    if( sample == "Oct19v6_MC_2016_GluGluHToBB_ext1" ) {  //29
	    dir_in = "MC_2016_Oct19/GluGluHToBB_M125_13TeV_amcatnloFXFX_pythia8/Oct19v6_MC_2016_GluGluHToBB_ext1/191202_141717/";
  	    nfiles = 31;
	    year = 2016; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluHToGG" ) {  //30 - GOOD
    ...
    // qqH 
    if( sample == "Oct19v2_MC_2016_VBFHToTauTau" ) {  //31
	    dir_in = "MC_2016_Oct19/VBFHToTauTau_M125_13TeV_powheg_pythia8/Oct19v2_MC_2016_VBFHToTauTau/191107_082009/";
  	    nfiles = 15;
	    year = 2016; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2016_VBF_HToZZTo4L" ) {  //32
	    dir_in = "MC_2016_Oct19/VBF_HToZZTo4L_M125_13TeV_powheg2_JHUgenV6_pythia8/Oct19v2_MC_2016_VBF_HToZZTo4L/191107_082113/";
  	    nfiles = 6;
	    year = 2016; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_VBFHToWWToLNuQQ" ) {  //33 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_VBFHToWWTo2L2Nu" ) {  //34 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_VBFHToMuMu" ) {  //35 - GOOD
    ...
    if( sample == "Oct19v3_MC_2016_VBFHToBB" ) {  //36 
	    dir_in = "MC_2016_Oct19/VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix/Oct19v3_MC_2016_VBFHToBB/191103_124304/";
  	    nfiles = 11;
	    year = 2016; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_VBFHToBB_ext1" ) {  //37 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_VBFHToGG_ext1" ) {  //38 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_VBFHToGG_ext2" ) {  //39 - GOOD
    ...
    // Rares
    if( sample == "Oct19v1_MC_2016_WWW" ) {  //40 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WWZ" ) {  //41 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WZZ" ) {  //42 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ZZZ" ) {  //43 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WZG" ) {  //44 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WGToLNuG_ext1" ) {  //45 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WGToLNuG_ext2" ) {  //46 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WGToLNuG_ext3" ) {  //47 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ZGTo2LG" ) {  //48 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TGJets_leptonDecays" ) {  //49 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTGJets" ) {  //50 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_TTGJets_ext1" ) {  //51 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_tZq_ll" ) {  //52
	    dir_in = "MC_2016_Oct19/tZq_ll_4f_13TeV-amcatnlo-pythia8/Oct19v2_MC_2016_tZq_ll/191107_082216/";
  	    nfiles = 117;
	    year = 2016; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_tZq_ll_PS" ) {  //53 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WpWpJJ" ) {  //54 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_WWTo2L2Nu_DoubleScattering" ) {  //55 
	    dir_in = "MC_2016_Oct19/WWTo2L2Nu_DoubleScattering_13TeV-pythia8/Oct19v2_MC_2016_WWTo2L2Nu_DoubleScattering/191107_082351/";
  	    nfiles = 8;
	    year = 2016; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_TTTT" ) {  //56 - GOOD
    ...
    // VH
    if( sample == "Oct19v1_MC_2016_VHToNonbb" ) {  //57 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ZH_HToBB_ZToLL" ) {  //58 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ZHToTauTau" ) {  //59 - GOOD
    ...
    // EWK
    if( sample == "Oct19v1_MC_2016_DYJetsToLL_M-10to50" ) {  //60 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_DYJetsToLL_M-50" ) {  //61 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WJetsToLNu_ext2" ) {  //62 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WJetsToLNu" ) {  //63 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WWTo2L2Nu" ) {  //64 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_WZTo3LNu" ) {  //65 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_ZZTo4L" ) {  //66 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_TTZH" ) {  //68 - GOOD
    ...
    // HH
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_SM" ) {  //69 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_box" ) {  //70 - GOOD
    ...
    if( sample == "Oct19v3_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_1" ) {  //71 - GOOD
	    dir_in = "MC_2016_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_1_13TeV-madgraph-v2/Oct19v3_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_1/191107_082510/";
  	    nfiles = 4;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_2" ) {  //72 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_3" ) {  //73 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_6" ) {  //76 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_7" ) {  //77 - GOOD
	    dir_in = "MC_2016_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_7_13TeV-madgraph-v2/Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_7/191015_122651/";
  	    nfiles = 4;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_8" ) {  //78 - GOOD
    ...
    if( sample == "Oct19v3_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_9" ) {  //79 - GOOD
	    dir_in = "/MC_2016_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_9_13TeV-madgraph-v2/Oct19v3_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_9/191103_124605/";
  	    nfiles = 3;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_10" ) {  //80 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_11" ) {  //81
	    dir_in = "MC_2016_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_11_13TeV-madgraph-v2/Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_11/191103_124710/";
  	    nfiles = 5;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_12" ) {  //82 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2Tau_node_SM" ) {  //83 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2Tau_node_box" ) {  //84 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2Tau_node_2" ) {  //85 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2Tau_node_9" ) {  //86 - GOOD
	    dir_in = "MC_2016_Oct19/GluGluToHHTo2B2Tau_node_9_13TeV-madgraph/Oct19v2_MC_2016_GluGluToHHTo2B2Tau_node_9/191015_123002/";
  	    nfiles = 3;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2Tau_node_10" ) {  //87 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2Tau_node_11" ) {  //88 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo2B2Tau_node_12" ) {  //89 - GOOD
    ...
    if( sample == "Oct19v3_MC_2016_GluGluToHHTo2B2Tau_node_13" ) {  //90
	    dir_in = "MC_2016_Oct19/GluGluToHHTo2B2Tau_node_13_13TeV-madgraph/Oct19v3_MC_2016_GluGluToHHTo2B2Tau_node_13/191120_075821/";
  	    nfiles = 3;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_SM" ) {  //91 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_box" ) {  //92 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_2" ) {  //93 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo4Tau_node_3" ) {  //94 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_4" ) {  //95 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_5" ) {  //96 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_6" ) {  //97 - GOOD
    ...
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_7" ) {  //98 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo4Tau_node_8" ) {  //99 - GOOD
	    dir_in = "MC_2016_Oct19/GluGluToHHTo4Tau_node_8_13TeV-madgraph/Oct19v2_MC_2016_GluGluToHHTo4Tau_node_8/191103_124810/";
  	    nfiles = 3;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_9" ) {  //100 - GOOD
    ...
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo4Tau_node_10" ) {  //101 - GOOD
	    dir_in = "MC_2016_Oct19/GluGluToHHTo4Tau_node_10_13TeV-madgraph/Oct19v2_MC_2016_GluGluToHHTo4Tau_node_10/191103_124916/";
  	    nfiles = 2;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2016_GluGluToHHTo4Tau_node_11" ) {  //102 - GOOD
	    dir_in = "MC_2016_Oct19/GluGluToHHTo4Tau_node_11_13TeV-madgraph/Oct19v2_MC_2016_GluGluToHHTo4Tau_node_11/191103_125000/";
  	    nfiles = 2;
	    year = 2016; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2016_GluGluToHHTo4Tau_node_12" ) {  //103 - GOOD
    ...
    // t(t)H
    if( sample == "Oct19v1_MC_2017_ttHJetToNonbb" ) {  //0 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_THQ_ctcvcp" ) {  //1 - GOOD
    ...
    if( sample == "Oct19v3_MC_2017_THW_ctcvcp" ) {  //2
	    dir_in = "MC_2017_Oct19/THW_ctcvcp_5f_Hincl_13TeV_madgraph_pythia8/Oct19v3_MC_2017_THW_ctcvcp/191202_142050/";
  	    nfiles = 172;
	    year = 2017; 
	    type = "ttH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_TTH_ctcvcp" ) {  //3 - GOOD
    ...
    // TTV
    if( sample == "Oct19v1_MC_2017_TTZToLLNuNu_M-10" ) {  //4 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTZToLLNuNu_M-10_PS" ) {  //5 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTZToLL_M-1to10" ) {  //6 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTWJetsToLNu" ) {  //7 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTWJetsToLNu_PS" ) {  //8 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTWW" ) {  //9 - GOOD
    ...
    // TT
    if( sample == "Oct19v1_MC_2017_ST_s-channel" ) {  //10 - GOOD
	    dir_in = "MC_2017_Oct19/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8/Oct19v1_MC_2017_ST_s-channel/191009_173308/";
  	    nfiles = 143;
	    year = 2017; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2017_ST_s-channel_PS" ) {  //11 - GOOD
	    dir_in = "MC_2017_Oct19/ST_s-channel_4f_leptonDecays_TuneCP5_PSweights_13TeV-amcatnlo-pythia8/Oct19v2_MC_2017_ST_s-channel_PS/191024_082000/";
  	    nfiles = 147;
	    year = 2017; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_ST_t-channel_top" ) {  //12 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_ST_t-channel_top_PS" ) {  //13
	    dir_in = "MC_2017_Oct19/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8/Oct19v2_MC_2017_ST_t-channel_top_PS/191107_102934/";
  	    nfiles = 2354;
	    year = 2017; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_ST_t-channel_antitop" ) {  //14 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_ST_t-channel_antitop_PS" ) {  //15
	    dir_in = "MC_2017_Oct19/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8/Oct19v2_MC_2017_ST_t-channel_antitop_PS/191107_093452/";
  	    nfiles = 1288;
	    year = 2017; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v3_MC_2017_ST_tW_top" ) {  //16 
	    dir_in = "MC_2017_Oct19/ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8/Oct19v3_MC_2017_ST_tW_top/191107_083049/";
  	    nfiles = 139;
	    year = 2017; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_ST_tW_top_PS" ) {  //17 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ST_tW_antitop" ) {  //18 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ST_tW_antitop_PS" ) {  //19 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ST_tWll" ) {  //20 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTJets_DiLept" ) {  //21 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTJets_SingleLeptFromT" ) {  //22 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTJets_SingleLeptFromTbar" ) {  //23 - GOOD
    ...
    if( sample == "Oct19v3_MC_2017_GluGluHToTauTau_ext1" ) {  //25
	    dir_in = "MC_2017_Oct19/GluGluHToTauTau_M125_13TeV_powheg_pythia8/Oct19v3_MC_2017_GluGluHToTauTau_ext1/191202_142214/";
  	    nfiles = 169;
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluHToZZTo4L_ext1" ) {  //26 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluHToZZTo4L_ext3" ) {  //27 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluHToZZTo4L_M125_13TeV_powheg2_JHUGenV7011_pythia8/Oct19v2_MC_2017_GluGluHToZZTo4L_ext3/191103_125651/";
  	    nfiles = 50;
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluHToZZTo4L_ext4" ) {  //28 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluHToZZTo2L2Q" ) {  //29 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluHToZZTo2L2Q_M125_13TeV_powheg2_JHUGenV7011_pythia8/Oct19v2_MC_2017_GluGluHToZZTo2L2Q/191103_125753/";
  	    nfiles = 48;
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluHToWWToLNuQQ" ) {  //30 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluHToWWTo2L2Nu" ) {  //31 - GOOD
    ...
    if( sample == "Oct19v3_MC_2017_GluGluHToMuMu" ) {  //32
	    dir_in = "MC_2017_Oct19/GluGluHToMuMu_M-125_TuneCP5_PSweights_13TeV_powheg_pythia8/Oct19v3_MC_2017_GluGluHToMuMu/191103_125916/";
  	    nfiles = 16;
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluHToMuMu_ext1" ) {  //33 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluHToBB" ) {  //34
	    dir_in = "MC_2017_Oct19/GluGluHToBB_M125_13TeV_amcatnloFXFX_pythia8/Oct19v2_MC_2017_GluGluHToBB/191107_083217/";
  	    nfiles = 200;
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v3_MC_2017_GluGluHToGG" ) {  //35 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluHToGG_M125_13TeV_amcatnloFXFX_pythia8/Oct19v3_MC_2017_GluGluHToGG/191103_184450/";
  	    nfiles = 61;
	    year = 2017; 
	    type = "ggH";
	    isMC = true;
    ...
    // qqH
    if( sample == "Oct19v1_MC_2017_VBFHToTauTau" ) {  //36 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_VBF_HToZZTo4L_ext2" ) {  //37 - GOOD
	    dir_in = "MC_2017_Oct19/VBF_HToZZTo4L_M125_13TeV_powheg2_JHUGenV7011_pythia8/Oct19v2_MC_2017_VBF_HToZZTo4L_ext2/191103_184640/";
  	    nfiles = 29;
	    year = 2017; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_VBF_HToZZTo4L_ext1" ) {  //38 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_VBF_HToZZTo4L" ) {  //39 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_VBFHToWWToLNuQQ" ) {  //40 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_VBFHToWWTo2L2Nu" ) {  //41 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_VBFHToMuMu" ) {  //42 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_VBFHToBB" ) {  //43 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_VBFHToGG" ) {  //44 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_VBFHToGG_PS" ) {  //45 ---> no info from crab???
	    dir_in = "MC_2017_Oct19/VBFHToGG_M125_13TeV_amcatnlo_pythia8_PSWeights/Oct19v2_MC_2017_VBFHToGG_PS/191107_103240/";
  	    nfiles = 16;
	    year = 2017; 
	    type = "VBF";
	    isMC = true;
    ...
    // Rares
    if( sample == "Oct19v1_MC_2017_WWW" ) {  //46 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_WWZ" ) {  //47 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_WZZ" ) {  //48 - GOOD
	    dir_in = "MC_2017_Oct19/WZZ_TuneCP5_13TeV-amcatnlo-pythia8/Oct19v2_MC_2017_WZZ/191103_184823/";
  	    nfiles = 5;
	    year = 2017; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2017_ZZZ" ) {  //49 ---> CHECK
	    dir_in = "MC_2017_Oct19/ZZZ_TuneCP5_13TeV-amcatnlo-pythia8/Oct19v2_MC_2017_ZZZ/191107_131427/";
  	    nfiles = 22;
	    year = 2017; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_WZG" ) {  //50 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_WGToLNuG" ) {  //51 - GOOD
	    dir_in = "MC_2017_Oct19/WGToLNuG_TuneCP5_13TeV-madgraphMLM-pythia8/Oct19v1_MC_2017_WGToLNuG/191009_190650/";
  	    nfiles = 134;
	    year = 2017; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_ZGToLLG" ) {  //52 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TGJets" ) {  //53 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTGJets" ) {  //54 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTGJets_ext1" ) {  //55 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_tZq_ll" ) {  //56 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_WpWpJJ" ) {  //57 - GOOD
	    dir_in = "MC_2017_Oct19/WpWpJJ_EWK-QCD_TuneCP5_13TeV-madgraph-pythia8/Oct19v2_MC_2017_WpWpJJ/191107_083344/";
  	    nfiles = 21;
	    year = 2017; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_WWTo2L2Nu_DoubleScattering" ) {  //58 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTTT" ) {  //59 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_TTTT_PS" ) {  //60 - GOOD
    ...
    // VH
    if( sample == "Oct19v1_MC_2017_VHToNonbb" ) {  //61 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ZH_HToBB_ZToLL" ) {  //62 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ZHToTauTau" ) {  //63 - GOOD
    ...
    // EWK
    if( sample == "Oct19v1_MC_2017_DYJetsToLL_M-10to50" ) {  //64 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_DYJetsToLL_M-10to50_ext1" ) {  //65 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_DYJetsToLL_M-50" ) {  //66 - GOOD
    ...
    if( sample == "Oct19v3_MC_2017_DYJetsToLL_M-50_ext1" ) {  //67
	    dir_in = "MC_2017_Oct19/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/Oct19v3_MC_2017_DYJetsToLL_M-50_ext1/191118_105255/";
  	    nfiles = 2005;
	    year = 2017; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2017_WJetsToLNu" ) {  //68
	    dir_in = "MC_2017_Oct19/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/Oct19v2_MC_2017_WJetsToLNu/191107_131252/";
  	    nfiles = 490;
	    year = 2017; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_WJetsToLNu_ext1" ) {  //69 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_WWTo2L2Nu" ) {  //70
	    dir_in = "MC_2017_Oct19/WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8/Oct19v2_MC_2017_WWTo2L2Nu/191107_093855/";
  	    nfiles = 25;
	    year = 2017; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_WWTo2L2Nu_ext1" ) {  //71 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_WZTo3LNu" ) {  //72 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ZZTo4L" ) {  //73 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_ZZTo4L_ext1" ) {  //74 - GOOD
    ...
    // TTVH
    if( sample == "Oct19v4_MC_2017_TTWH" ) {  //76
	    dir_in = "MC_2017_Oct19/TTWH_TuneCP5_13TeV-madgraph-pythia8/Oct19v4_MC_2017_TTWH/191202_142352/";
  	    nfiles = 5;
	    year = 2017; 
	    type = "ttVH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_TTZH" ) {  //77 - GOOD
    ...
    // HH
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_SM" ) {  //78
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_SM_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_SM/191103_185302/";
  	    nfiles = 17;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_2" ) {  //79
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_2_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_2/191107_094010/";
  	    nfiles = 17;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_3" ) {  //80 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_3_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_3/191107_094055/";
  	    nfiles = 17;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_7" ) {  //81 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_7_13TeV-madgraph_correctedcfg/Oct19v1_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_7/191009_193242/";
  	    nfiles = 19;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_9" ) {  //82 - GOOD
    ...
    if( sample == "Oct19v4_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_12" ) {  //83
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2B2VTo2L2Nu_node_12_13TeV-madgraph_correctedcfg/Oct19v4_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_12/191202_142513/";
  	    nfiles = 23;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_SM" ) {  //84 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_2" ) {  //85 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_3" ) {  //86 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_4" ) {  //87 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_7" ) {  //88 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_9" ) {  //89 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2B2Tau_node_12" ) {  //90 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4Tau_node_SM_13" ) {  //91 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4Tau_node_2" ) {  //92 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4Tau_node_3" ) {  //93 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo4Tau_node_7" ) {  //94- GOOD
	    dir_in = "MC_2017_Oct19/GluGluToHHTo4Tau_node_7_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo4Tau_node_7/191103_185710/";
  	    nfiles = 16;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4Tau_node_9" ) {  //95 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4Tau_node_12" ) {  //96 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_SM" ) {  //97 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2V2Tau_node_SM_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_SM/191107_094703/";
  	    nfiles = 15;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_2" ) {  //98 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_3" ) {  //99
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2V2Tau_node_3_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_3/191107_083443/";
  	    nfiles = 14;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_4" ) {  //100 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_5" ) {  //101 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_6" ) {  //102 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_7" ) {  //103
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2V2Tau_node_7_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_7/191107_094813/";
  	    nfiles = 20;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_8" ) {  //104 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_9" ) {  //105 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_10" ) {  //106 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo2V2Tau_node_11" ) {  //107 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_12" ) {  //108
	    dir_in = "MC_2017_Oct19/GluGluToHHTo2V2Tau_node_12_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_12/191107_094918/";
  	    nfiles = 20;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_SM" ) {  //109 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo4V_node_2" ) {  //110 - GOOD
	    dir_in = "MC_2017_Oct19/GluGluToHHTo4V_node_2_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo4V_node_2/191103_185919/";
  	    nfiles = 15;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_3" ) {  //111 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_4" ) {  //112 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_5" ) {  //113 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_6" ) {  //114 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_7" ) {  //115 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_8" ) {  //116 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_9" ) {  //117 - GOOD
    ...
    if( sample == "Oct19v1_MC_2017_GluGluToHHTo4V_node_10" ) {  //118 - GOOD
    ...
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo4V_node_11" ) {  //119
	    dir_in = "MC_2017_Oct19/GluGluToHHTo4V_node_11_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo4V_node_11/191103_190029/";
  	    nfiles = 17;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2017_GluGluToHHTo4V_node_12" ) {  //120
	    dir_in = "MC_2017_Oct19/GluGluToHHTo4V_node_12_13TeV-madgraph_correctedcfg/Oct19v2_MC_2017_GluGluToHHTo4V_node_12/191107_095025/";
  	    nfiles = 13;
	    year = 2017; 
	    type = "HH";
	    isMC = true;
    ...
    // t(t)H
    if( sample == "Oct19v2_MC_2018_ttHJetToNonbb" ) {  //0
	    dir_in = "MC_2018_Oct19/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8/Oct19v2_MC_2018_ttHJetToNonbb/191106_144219/";
  	    nfiles = 261;
	    year = 2018; 
	    type = "ttH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_THQ_ctcvcp" ) {  //1 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_THW_ctcvcp" ) {  //2 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_TTH_ctcvcp" ) {  //3 - GOOD
	    dir_in = "MC_2018_Oct19/TTH_4f_ctcvcp_TuneCP5_13TeV_madgraph_pythia8/Oct19v2_MC_2018_TTH_ctcvcp/191107_132130/";
  	    nfiles = 720;
	    year = 2018; 
	    type = "ttH";
	    isMC = true;
    ...
    // TTV
    if( sample == "Oct19v1_MC_2018_TTZToLLNuNu_M-10" ) {  //4 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTZToLL_M-1to10" ) {  //5 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTWJetsToLNu" ) {  //6 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTWW_ext1" ) {  //7 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTWW_ext2" ) {  //8 - GOOD
    ...
    // TT
    if( sample == "Oct19v1_MC_2018_ST_s-channel" ) {  //9 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_ST_t-channel_top" ) {  //10
	    dir_in = "MC_2018_Oct19/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8/Oct19v2_MC_2018_ST_t-channel_top/191108_080616/";
  	    nfiles = 2394;
	    year = 2018; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v3_MC_2018_ST_t-channel_antitop" ) {  //11
	    dir_in = "MC_2018_Oct19/ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8/Oct19v3_MC_2018_ST_t-channel_antitop/191106_144323/";
  	    nfiles = 1319;
	    year = 2018; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v3_MC_2018_ST_tW_top" ) {  //12
	    dir_in = "MC_2018_Oct19/ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8/Oct19v3_MC_2018_ST_tW_top/191202_142648/";
  	    nfiles = 173;
	    year = 2018; 
	    type = "ttbar";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_ST_tW_antitop" ) {  //13 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_ST_tWll" ) {  //14 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTJets_DiLept" ) {  //15 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTJets_SingleLeptFromT" ) {  //16 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_TTJets_SingleLeptFromTbar" ) {  //17 - GOOD
	    dir_in = "MC_2018_Oct19/TTJets_SingleLeptFromTbar_TuneCP5_13TeV-madgraphMLM-pythia8/Oct19v2_MC_2018_TTJets_SingleLeptFromTbar/191107_131950/";
  	    nfiles = 1244;
	    year = 2018; 
	    type = "ttbar";
	    isMC = true;
    ...
    if( sample == "Oct19v2_MC_2018_GluGluHToTauTau" ) {  //18 - GOOD
	    dir_in = "MC_2018_Oct19/GluGluHToTauTau_M125_13TeV_powheg_pythia8/Oct19v2_MC_2018_GluGluHToTauTau/191106_144424/";
  	    nfiles = 188;
	    year = 2018; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_GluGluHToZZTo4L" ) {  //19 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_GluGluHToZZTo2L2Q" ) {  //20
	    dir_in = "MC_2018_Oct19/GluGluHToZZTo2L2Q_M125_13TeV_powheg2_JHUGenV7011_pythia8/Oct19v2_MC_2018_GluGluHToZZTo2L2Q/191103_190812/";
  	    nfiles = 30;
	    year = 2018; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_GluGluHToWWToLNuQQ" ) {  //21 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_GluGluHToWWTo2L2Nu" ) {  //22
	    dir_in = "MC_2018_Oct19/GluGluHToWWTo2L2Nu_M125_13TeV_powheg2_JHUGenV714_pythia8/Oct19v2_MC_2018_GluGluHToWWTo2L2Nu/191103_191258/";
  	    nfiles = 33;
	    year = 2018; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_GluGluHToMuMu" ) {  //23 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_GluGluHToMuMu_ext1" ) {  //24
	    dir_in = "MC_2018_Oct19/GluGluHToMuMu_M-125_TuneCP5_PSweights_13TeV_powheg_pythia8/Oct19v2_MC_2018_GluGluHToMuMu_ext1/191103_191357/";
  	    nfiles = 37;
	    year = 2018; 
	    type = "ggH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_GluGluHToBB" ) {  //25 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_GluGluHToGG" ) {  //26 - GOOD
    ...
    // qqH
    if( sample == "Oct19v1_MC_2018_VBFHToTauTau" ) {  //27 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_VBF_HToZZTo4L" ) {  //28 - GOOD
	    dir_in = "MC_2018_Oct19/VBF_HToZZTo4L_M125_13TeV_powheg2_JHUGenV7011_pythia8/Oct19v2_MC_2018_VBF_HToZZTo4L/191103_191518/";
  	    nfiles = 29;
	    year = 2018; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_VBFHToWWToLNuQQ" ) {  //29
	    dir_in = "MC_2018_Oct19/VBFHToWWToLNuQQ_M125_13TeV_powheg_JHUGen_pythia8/Oct19v2_MC_2018_VBFHToWWToLNuQQ/191103_191602/";
  	    nfiles = 24;
	    year = 2018; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_VBFHToWWTo2L2Nu" ) {  //30 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_VBFHToMuMu" ) {  //31 - GOOD
	    dir_in = "MC_2018_Oct19/VBFHToMuMu_M-125_TuneCP5_PSweights_13TeV_powheg_pythia8/Oct19v1_MC_2018_VBFHToMuMu/191009_204042/";
  	    nfiles = 38;
	    year = 2018; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_VBFHToBB" ) {  //32
	    dir_in = "MC_2018_Oct19/VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix/Oct19v2_MC_2018_VBFHToBB/191107_083647/";
  	    nfiles = 206;
	    year = 2018; 
	    type = "VBF";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_VBFHToGG" ) {  //33
	    dir_in = "MC_2018_Oct19/VBFHToGG_M125_13TeV_amcatnlo_pythia8/Oct19v2_MC_2018_VBFHToGG/191107_083731/";
  	    nfiles = 44;
	    year = 2018; 
	    type = "VBF";
	    isMC = true;
    ...
    // Rares
    if( sample == "Oct19v2_MC_2018_WWW" ) {  //34 - GOOD
	    dir_in = "MC_2018_Oct19/WWW_4F_TuneCP5_13TeV-amcatnlo-pythia8/Oct19v2_MC_2018_WWW/191103_192052/";
  	    nfiles = 12;
	    year = 2018; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_WWZ" ) {  //35 - GOOD
	    dir_in = "MC_2018_Oct19/WWZ_TuneCP5_13TeV-amcatnlo-pythia8/Oct19v2_MC_2018_WWZ/191103_192136/";
  	    nfiles = 15;
	    year = 2018; 
	    type = "Rares";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_WZZ" ) {  //36 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_ZZZ" ) {  //37 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_WZG" ) {  //38 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_WGToLNuG" ) {  //39 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_ZGToLLG" ) {  //40
	    dir_in = "MC_2017_Oct19/ZGToLLG_01J_5f_TuneCP5_13TeV-amcatnloFXFX-pythia8/Oct19v1_MC_2017_ZGToLLG/191009_190740/";
  	    nfiles = 512;
	    year = 2018; 
	    type = "Rares";
    ...
    if( sample == "Oct19v1_MC_2018_TGJets" ) {  //41 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTGJets" ) {  //42 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_tZq_ll" ) {  //43 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_WpWpJJ" ) {  //44 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_WWTo2L2Nu_DoubleScattering" ) {  //45 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_TTTT" ) {  //46 - GOOD
    ...
    // VH
    if( sample == "Oct19v2_MC_2018_VHToNonbb" ) {  //47
	    dir_in = "MC_2018_Oct19/VHToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8/Oct19v2_MC_2018_VHToNonbb/191107_083838/";
  	    nfiles = 30;
	    year = 2018; 
	    type = "VH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_ZH_HToBB_ZToLL" ) {  //48 - GOOD
    ...
    if( sample == "Oct19v3_MC_2018_ZH_HToBB_ZToLL_ext1" ) {  //49 - GOOD
	    dir_in = "MC_2018_Oct19/ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8/Oct19v3_MC_2018_ZH_HToBB_ZToLL_ext1/191106_144652/";
  	    nfiles = 108;
	    year = 2018; 
	    type = "VH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_ZHToTauTau" ) {  //50 - GOOD
    ...
    // EWK
    if( sample == "Oct19v3_MC_2018_DYJetsToLL_M-10to50" ) {  //51
	    dir_in = "MC_2018_Oct19/DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8/Oct19v3_MC_2018_DYJetsToLL_M-10to50/191107_084118/";
  	    nfiles = 569;
	    year = 2018; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_DYJetsToLL_M-50" ) {  //52 - GOOD
	    dir_in = "MC_2018_Oct19/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/Oct19v2_MC_2018_DYJetsToLL_M-50/191015_124517/";
  	    nfiles = 15;
	    year = 2018; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v3_MC_2018_DYJetsToLL_M-50_ext2" ) {  //53
	    dir_in = "MC_2018_Oct19/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/Oct19v3_MC_2018_DYJetsToLL_M-50_ext2/191106_144755/";
  	    nfiles = 2045;
	    year = 2018; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_WJetsToLNu" ) {  //54 - GOOD
    ...
    if( sample == "Oct19v3_MC_2018_WWTo2L2Nu" ) {  //55 - GOOD
	    dir_in = "MC_2018_Oct19/WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8/Oct19v3_MC_2018_WWTo2L2Nu/191103_192743/";
  	    nfiles = 172;
	    year = 2018; 
	    type = "EWK";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_WZTo3LNu" ) {  //56 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_WZTo3LNu_ext1" ) {  //57 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_ZZTo4L" ) {  //58 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_TTZH" ) {  //61 - GOOD
    ...
    // HH
    if( sample == "Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_SM" ) {  //62 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_GluGluToHHTo2B2Tau_node_2" ) {  //63 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_3" ) {  //64 - GOOD
	    dir_in = "MC_2018_Oct19/GluGluToHHTo2B2Tau_node_3_TuneCP5_PSWeights_13TeV-madgraph-pythia8/Oct19v2_GluGluToHHTo2B2Tau_node_3/191103_192920/";
  	    nfiles = 16;
	    year = 2018; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v1_MC_2018_GluGluToHHTo2B2Tau_node_4" ) {  //65 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_GluGluToHHTo2B2Tau_node_5" ) {  //66 - GOOD
    ...
    if( sample == "Oct19v1_MC_2018_GluGluToHHTo2B2Tau_node_6" ) {  //67 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_7" ) {  //68 - GOOD
    ...
    if( sample == "Oct19v3_MC_2018_GluGluToHHTo2B2Tau_node_8" ) {  //69 - GOOD
	    dir_in = "MC_2018_Oct19/GluGluToHHTo2B2Tau_node_8_TuneCP5_PSWeights_13TeV-madgraph-pythia8/Oct19v3_GluGluToHHTo2B2Tau_node_8/191103_193033/";
  	    nfiles = 15;
	    year = 2018; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_9" ) {  //70 - GOOD
    ...
    if( sample == "Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_10" ) {  //71 - GOOD
    ...
    if( sample == "Oct19v3_MC_2018_GluGluToHHTo2B2Tau_node_11" ) {  //72
	    dir_in = "MC_2018_Oct19/GluGluToHHTo2B2Tau_node_11_TuneCP5_PSWeights_13TeV-madgraph-pythia8/Oct19v3_GluGluToHHTo2B2Tau_node_11/191106_145038/";
  	    nfiles = 12;
	    year = 2018; 
	    type = "HH";
	    isMC = true;
    }
    if( sample == "Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_12" ) {  //73 - DONE
...
std::tuple< TString, TString, TString, vector<TString>, int, bool > load_sample_converter_MC ( TString sample = "Oct19v1_MC_2016_ttHJetToNonbb", int split=0, int i_split=0, int JEC=0, int TES=0){

	auto file_info = get_parameters_MC(sample);
	...
	TString file = "ntuple_newConePt_"+sample;
