...
std::tuple<TString, int, int, int, TString, bool> get_parameters( TString sample = "Oct19v1_MC_2016_ttHJetToNonbb" ){
    ...
    /*if( sample == "Oct19v2_MC_2016_TTJets_SingleLeptFromT_ext1" ) {  //19
	    dir_in = //->CHECK!
  	    nfiles = //->CHECK!
	    year = 2016; 
	    type = "ttbar";
    ...
    /*if( sample == "Oct19v2_MC_2016_TTJets_SingleLeptFromTbar_ext1" ) {  //22
	    dir_in = //->CHECK!
  	    nfiles = //->CHECK!
	    year = 2016; 
	    type = "ttbar";
    ...
    /*if( sample == "Oct19v2_MC_2016_GluGluHToBB_ext1" ) {  //29
	    dir_in = // ---> CHECK???
  	    nfiles = // ---> CHECK???
	    year = 2016; 
	    type = "ggH";
    ...
    /*if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2VTo2L2Nu_node_4" ) {  //74
	    dir_in = // ---> CHECK!
  	    nfiles = // ---> CHECK!
	    year = 2016; 
	    type = "HH";
    ...
    /*if( sample == "Oct19v2_MC_2016_GluGluToHHTo2B2Tau_node_13" ) {  //90
	    dir_in = //-->CHECK!
  	    nfiles = //-->CHECK!
	    year = 2016; 
	    type = "HH";
    ...
    /*if( sample == "Oct19v2_MC_2017_THW_ctcvcp" ) {  //2
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ttH";
    ...
    /*if( sample == "Oct19v2_MC_2017_GluGluHToTauTau_ext1" ) {  //25
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ggH";
    ...
    /*if( sample == "Oct19v2_MC_2017_GluGluHToZZTo2L2Q" ) {  //29
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ggH";
    ...
    /*if( sample == "Oct19v1_MC_2017_GluGluHToBB" ) {  //34
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ggH";
    ...
    /*if( sample == "Oct19v3_MC_2017_GluGluHToGG" ) {  //35
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ggH";
    ...
    /*if( sample == "Oct19v2_MC_2017_VBF_HToZZTo4L_ext2" ) {  //37
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "VBF";
    ...
    /*if( sample == "Oct19v2_MC_2017_WZZ" ) {  //48
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "Rares";
    ...
    /*if( sample == "Oct19v2_MC_2017_DYJetsToLL_M-50_ext1" ) {  //67
	    dir_in = // -> CHECK!
  	    nfiles = // -> CHECK!
	    year = 2017; 
	    type = "EWK";
    ...
    // TTVH
    /*if( sample == "Oct19v2_MC_2017_TTWH" ) {  //76
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "ttVH";
    ...
    /*if( sample == "Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_3" ) {  //80
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "HH";
    ...
    /*if( sample == "Oct19v2_MC_2017_GluGluToHHTo2B2VTo2L2Nu_node_12" ) {  //83
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "HH";
    ...
    /*if( sample == "Oct19v2_MC_2017_GluGluToHHTo2V2Tau_node_SM" ) {  //97
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2017; 
	    type = "HH";
    ...
    /*if( sample == "Oct19v2_MC_2018_TTH_ctcvcp" ) {  //3
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "ttH";
    ...
    /*if( sample == "Oct19v2_MC_2018_ST_t-channel_antitop" ) {  //11
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "ttbar";
    ...
    /*if( sample == "Oct19v2_MC_2018_ST_tW_top" ) {  //12
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "ttbar";
    ...
    /*if( sample == "Oct19v2_MC_2018_TTJets_SingleLeptFromTbar" ) {  //17
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "ttbar";
    ...
    // ggH
    /*if( sample == "Oct19v2_MC_2018_GluGluHToTauTau" ) {  //18
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "ggH";
    ...
    /*if( sample == "Oct19v3_MC_2018_ZH_HToBB_ZToLL_ext1" ) {  //49
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "VH";
    ...
    /*if( sample == "Oct19v3_MC_2018_WWTo2L2Nu" ) {  //55
	    dir_in = // --> CHECK!
  	    nfiles = // --> CHECK!
	    year = 2018; 
	    type = "EWK";
...
std::tuple< TString, TString, TString, vector<TString>, int, bool > load_sample_converter( TString sample = "Oct19v1_MC_2016_ttHJetToNonbb", int split=0, int i_split=0, int JEC=0, int TES=0){
