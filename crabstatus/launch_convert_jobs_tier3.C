...
void create_scripts( TString sample="Oct19v1_MC_2016_THQ_ctcvcp", int maxsplit=0, TString year="2016", TString type="MC" ){
 ...
 for(int j=0;j<maxsplit+1;j++){ //maxsplit -> blocks of 100 files in crab
    ...
    myscript << "convert_tree(\""+sample+"\",0,"<< j << ",0,0);\n";
    myscript << ".q\n";
    myscript << "EOF\n";
    myscript.close();   
...
void create_scripts_all(){
    ...
    */
    ...
    //PENDING
    /*
    create_scripts("Oct19v1_MC_2016_WGToLNuG_ext3",0,"2016","MC"); //0(7/11) **
    create_scripts("Oct19v1_MC_2017_ZGToLLG",5,"2017","MC"); // 0,1,3->done, 2(5M/6M), 4,5->NOT CONSIDERED
    create_scripts("Oct19v1_MC_2016_WJetsToLNu_ext2",4,"2016","MC"); //0,2,3->done, 0(8/13), 1(17M/27M), 4->NOT CONSIDERED
    create_scripts("Oct19v1_MC_2017_DYJetsToLL_M-50",3,"2017","MC"); //2(2M/9.2M), 0,1,3->done      
    create_scripts("Oct19v1_MC_2016_DYJetsToLL_M-10to50",2,"2016","MC");
    create_scripts("Oct19v1_MC_2017_VBFHToWWToLNuQQ",0,"2017","MC");
    create_scripts("Oct19v1_MC_2017_VBFHToGG",0,"2017","MC");
    create_scripts("Oct19v1_MC_2018_GluGluHToWWToLNuQQ",0,"2018","MC");
    create_scripts("Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_10",0,"2018","MC");     
    create_scripts("Oct19v1_MC_2016_THQ_ctcvcp", 0, "2016", "MC" );
    */
...
void launch_scripts_all(){
    ...
    launch_scripts("Oct19v1_MC_2018_GluGluHToWWToLNuQQ",0,"2018","MC");
    launch_scripts("Oct19v2_MC_2018_GluGluToHHTo2B2Tau_node_10",0,"2018","MC");
...
void launch_single_script_all(){
    ...
    launch_single_script("Oct19v1_MC_2016_WGToLNuG_ext3",0,"2016","MC");
    launch_single_script("Oct19v1_MC_2017_ZGToLLG",2,"2017","MC");
    //launch_single_script("Oct19v1_MC_2017_ZGToLLG",4,"2017","MC");
    //launch_single_script("Oct19v1_MC_2017_ZGToLLG",5,"2017","MC");
    launch_single_script("Oct19v1_MC_2016_ttHJetToNonbb",0,"2016","MC");
    launch_single_script("Oct19v1_MC_2016_WJetsToLNu_ext2",0,"2016","MC");
    launch_single_script("Oct19v1_MC_2016_WJetsToLNu_ext2",1,"2016","MC");
    //launch_single_script("Oct19v1_MC_2016_WJetsToLNu_ext2",4,"2016","MC");
    launch_single_script("Oct19v1_MC_2017_DYJetsToLL_M-50",0,"2017","MC");
    launch_single_script("Oct19v1_MC_2017_DYJetsToLL_M-50",2,"2017","MC");
