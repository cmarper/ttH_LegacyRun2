...
std::tuple< TString, TString, TString, vector<TString> > setup_files(TString sample, int split, int i_split, int JEC, int TES){
  ...
  if(sample=="MC_2016_v2_TTZ_M1to10"){ 
    file="ntuple_"+sample;
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/ntuples_converted/";
    dir_out+="2016/";
    if(JEC>0)
      ...
      dir_out+="nominal/";
    dir_out+="ttV/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH_Legacy/MC_2016_v1/TTZToLL_M-1to10_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MC_2016_v2_TTZ_M1to10/190812_095527/";
    int i_dir=i_split/10;
    dir_in+=Form("000%i/",i_dir);
    int i_min=i_split*100;
    if(i_split==0) i_min++;
  ...
  if(sample=="MC_2016_v2_TTJets_TToSingleLep_ext"){ 
    ...
    if(JEC>0)
      ...
      dir_out+="nominal/";
    dir_out+="TT/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH_Legacy/MC_2016_v1/MC_2016_v1/TTJets_SingleLeptFromT_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MC_2016_v2_TTJets_TToSingleLep_ext/190812_095708/";
    int i_dir=i_split/10;
    dir_in+=Form("000%i/",i_dir);
    int i_min=i_split*100;
    if(i_split==0) i_min++;
  ...
  if(sample=="MC_2017_v1_TTWJets"){
    ...
    if(JEC>0)
      ...
      dir_out+="nominal/";
    dir_out+="ttV/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH_Legacy/MC_2017_v1/TTWJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/MC_2017_v1_TTWJets/190704_091853/";
    int i_dir=i_split/10;
    dir_in+=Form("000%i/",i_dir);
    int i_min=i_split*100;
    if(i_split==0) i_min++;
  ...
  if(sample=="MC_2017_v1_ZZZ"){ 
    ...
    if(JEC>0)
      ...
      dir_out+="nominal/";
    dir_out+="Rares/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH_Legacy/MC_2017_v1/ZZZ_TuneCP5_13TeV-amcatnlo-pythia8/MC_2017_v1_ZZZ/190704_093527/";
    int i_dir=i_split/10;
    dir_in+=Form("000%i/",i_dir);
    int i_min=i_split*100;
    if(i_split==0) i_min++;
