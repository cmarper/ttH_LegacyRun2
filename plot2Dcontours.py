...
if doContours :
    ...
    #gr68 = contourPlot(tree68, 0.31, 1.0, bestfit)
    gr68.SetLineWidth(2)
    gr68.SetLineStyle(1)
    gr68.SetLineColor(1)
...
hist.GetYaxis().SetTitle("#mu_{"+to_do_first.replace("r_","")+"}")
...
lat.SetTextSize(26)
lat.DrawLatex(0.14, 0.845, "pp #rightarrow t#bar{t}H, H #rightarrow WW*/ZZ*/#tau#tau")
