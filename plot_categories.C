...
void plot_categories(){
  ...
  TLatex *texl1 = new TLatex(0.1,1.03,"CMS #bf{#it{Preliminary}}");
  texl1->SetTextSize(0.06);

  TLatex *texl2 = new TLatex(7.6,1.03,"#bf{137 fb^{-1} (13 TeV)}");
  texl2->SetTextSize(0.06);
  ...
  hs->GetXaxis()->SetLabelSize(0.069);

  h_hww->SetTitle(" ");
  h_hww->SetStats(0);

  TLegend* leg=new TLegend(0.69,0.5,0.87,0.74);
  leg->SetBorderSize(0);
