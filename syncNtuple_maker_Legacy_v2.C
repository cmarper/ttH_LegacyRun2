...
void create_syncNtuple_objectbased(int year=2016){
  ...
  TString file;
  if(year==2016) file="sync_ntuple_objects_syncformat_ttHNonbb_2016_v12.root";
  ...
  vector<TString> list;
  if(year==2016) list.push_back(dir_in+"sync_ntuple_converted_ttHNonbb_2016_v15.root");
...
void create_syncNtuple_eventbased(int year=2016){
  ...
  TString file;
  if(year==2016) file="sync_ntuple_events_syncformat_ttHNonbb_2016_v5.root";
  else if(year==2017) file="sync_ntuple_events_syncformat_ttHNonbb_2017_v4.root";
  else if(year==2018) file="sync_ntuple_events_syncformat_ttHNonbb_2018_v4.root";

  vector<TString> list;
  if(year==2016) list.push_back(dir_in+"sync_ntuple_splitted_ttHNonbb_2016_v5.root");
  else if(year==2017) list.push_back(dir_in+"sync_ntuple_splitted_ttHNonbb_2017_v4.root");
  else if(year==2018) list.push_back(dir_in+"sync_ntuple_splitted_ttHNonbb_2018_v4.root");
