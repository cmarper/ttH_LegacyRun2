...
void convert_tree(
  ...
  //auto file_info = setup_files(sample, split, i_split, JEC, TES);

  auto file_info = load_sample_converter_MC(sample,split,i_split,JEC,TES);

  TString dir_in        = std::get<0>(file_info);
  TString dir_out       = std::get<1>(file_info);
  TString file          = std::get<2>(file_info);
  vector<TString> list  = std::get<3>(file_info);
  int year 		= std::get<4>(file_info);


  cout<<" "<<endl;
  cout<<"Directory in: "<<dir_in<<endl;
  cout<<"Directory out: "<<dir_out<<endl;
  ...
  cout<<"File out: "<<file<<endl;

  TChain * tree = new TChain("HTauTauTree/Tree");
  int nFiles = list.size();
  cout<<"Number of files in: "<<nFiles<<endl;
  ...
  vector<bool> *_daughters_iseleNoIsoWP80;
  vector<bool> *_daughters_iseleNoIsoWP90;

  vector<float> *_daughters_e;
  vector<float> *_daughters_px;
  vector<float> *_daughters_py;
  vector<float> *_daughters_pz;
  vector<int>   *_daughters_matchedMaxPtJetIndex;
  ...
  vector<float> *_daughters_byDeepTau2017v2p1VSjetraw;
  vector<float> *_daughters_byDeepTau2017v2p1VSeraw;
  vector<float> *_daughters_byDeepTau2017v2p1VSmuraw;
  ...
  tree->SetBranchAddress("daughters_iseleNoIsoWP80",&_daughters_iseleNoIsoWP80);
  tree->SetBranchAddress("daughters_iseleNoIsoWP90",&_daughters_iseleNoIsoWP90);
  ...
  tree->SetBranchAddress("daughters_matchedMaxPtJetIndex",&_daughters_matchedMaxPtJetIndex);
  ...
  tree->SetBranchAddress("daughters_byDeepTau2017v2p1VSjetraw",&_daughters_byDeepTau2017v2p1VSjetraw);
  tree->SetBranchAddress("daughters_byDeepTau2017v2p1VSeraw",&_daughters_byDeepTau2017v2p1VSeraw);
  tree->SetBranchAddress("daughters_byDeepTau2017v2p1VSmuraw",&_daughters_byDeepTau2017v2p1VSmuraw);
  ...
  vector<int>   _recomu_matchedGenPartIdx;
  ...
  vector<int>   _recoele_matchedGenPartIdx;
  ...
  vector<float> _recolep_uncorr_pt;
  ...
  vector<int>   _recolep_matchedGenPartIdx;
  ...
  vector<int>   _recotauh_byMediumDeepTau2017v2p1VSjet;
  ...
  tree_new->Branch("recomu_matchedGenPartIdx",&_recomu_matchedGenPartIdx);
  ...
  tree_new->Branch("recoele_matchedGenPartIdx",&_recoele_matchedGenPartIdx);
  ...
  tree_new->Branch("recolep_uncorr_pt",&_recolep_uncorr_pt);
  ...
  tree_new->Branch("recolep_matchedGenPartIdx",&_recolep_matchedGenPartIdx);
  ...
  tree_new->Branch("recotauh_byVVVLooseDeepTau2017v2p1VSjet",&_recotauh_byVVVLooseDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byVVLooseDeepTau2017v2p1VSjet",&_recotauh_byVVLooseDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byVLooseDeepTau2017v2p1VSjet",&_recotauh_byVLooseDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byLooseDeepTau2017v2p1VSjet",&_recotauh_byLooseDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byMediumDeepTau2017v2p1VSjet",&_recotauh_byMediumDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byTightDeepTau2017v2p1VSjet",&_recotauh_byTightDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byVTightDeepTau2017v2p1VSjet",&_recotauh_byVTightDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byVVTightDeepTau2017v2p1VSjet",&_recotauh_byVVTightDeepTau2017v2p1VSjet);
  tree_new->Branch("recotauh_byVVVLooseDeepTau2017v2p1VSe",&_recotauh_byVVVLooseDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byVVLooseDeepTau2017v2p1VSe",&_recotauh_byVVLooseDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byVLooseDeepTau2017v2p1VSe",&_recotauh_byVLooseDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byLooseDeepTau2017v2p1VSe",&_recotauh_byLooseDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byMediumDeepTau2017v2p1VSe",&_recotauh_byMediumDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byTightDeepTau2017v2p1VSe",&_recotauh_byTightDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byVTightDeepTau2017v2p1VSe",&_recotauh_byVTightDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byVVTightDeepTau2017v2p1VSe",&_recotauh_byVVTightDeepTau2017v2p1VSe);
  tree_new->Branch("recotauh_byVLooseDeepTau2017v2p1VSmu",&_recotauh_byVLooseDeepTau2017v2p1VSmu);
  tree_new->Branch("recotauh_byLooseDeepTau2017v2p1VSmu",&_recotauh_byLooseDeepTau2017v2p1VSmu);
  tree_new->Branch("recotauh_byMediumDeepTau2017v2p1VSmu",&_recotauh_byMediumDeepTau2017v2p1VSmu);
  tree_new->Branch("recotauh_byTightDeepTau2017v2p1VSmu",&_recotauh_byTightDeepTau2017v2p1VSmu);
  tree_new->Branch("recotauh_byDeepTau2017v2p1VSjetraw",&_recotauh_byDeepTau2017v2p1VSjetraw);
  tree_new->Branch("recotauh_byDeepTau2017v2p1VSeraw",&_recotauh_byDeepTau2017v2p1VSeraw);
  tree_new->Branch("recotauh_byDeepTau2017v2p1VSmuraw",&_recotauh_byDeepTau2017v2p1VSmuraw);
  ...
  tree_new->Branch("recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Up",&_recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Up);
  tree_new->Branch("recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Down",&_recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Down);
  tree_new->Branch("recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Up",&_recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Up);
  tree_new->Branch("recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Down",&_recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Down);
  tree_new->Branch("recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Up",&_recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Up);
  tree_new->Branch("recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Down",&_recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Down);
  tree_new->Branch("recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Up",&_recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Up);
  tree_new->Branch("recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Down",&_recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Down);
  ...
  tree_new->Branch("recoPFak8Jet_subjet1_e",&_recoPFak8Jet_subjet1_e);
  tree_new->Branch("recoPFak8Jet_subjet1_pt",&_recoPFak8Jet_subjet1_pt);
  tree_new->Branch("recoPFak8Jet_subjet1_px",&_recoPFak8Jet_subjet1_px);
  tree_new->Branch("recoPFak8Jet_subjet1_py",&_recoPFak8Jet_subjet1_py);
  tree_new->Branch("recoPFak8Jet_subjet1_pz",&_recoPFak8Jet_subjet1_pz);
  tree_new->Branch("recoPFak8Jet_subjet1_eta",&_recoPFak8Jet_subjet1_eta);
  tree_new->Branch("recoPFak8Jet_subjet1_phi",&_recoPFak8Jet_subjet1_phi);

  tree_new->Branch("recoPFak8Jet_subjet2_e",&_recoPFak8Jet_subjet2_e);
  tree_new->Branch("recoPFak8Jet_subjet2_pt",&_recoPFak8Jet_subjet2_pt);
  tree_new->Branch("recoPFak8Jet_subjet2_px",&_recoPFak8Jet_subjet2_px);
  tree_new->Branch("recoPFak8Jet_subjet2_py",&_recoPFak8Jet_subjet2_py);
  tree_new->Branch("recoPFak8Jet_subjet2_pz",&_recoPFak8Jet_subjet2_pz);
  tree_new->Branch("recoPFak8Jet_subjet2_eta",&_recoPFak8Jet_subjet2_eta);
  tree_new->Branch("recoPFak8Jet_subjet2_phi",&_recoPFak8Jet_subjet2_phi);
  ...
  int _lheNOutB = -1;
  int _lheNOutC = -1;
  vector<float> _lhePartons_px, _lhePartons_py, _lhePartons_pz, _lhePartons_e, _lhePartons_PdgId;
  ...
  if(!isMC && JEC==0 && TES==0){
    ...
    tree_new->Branch("lhePartons_px", &_lhePartons_px);
    tree_new->Branch("lhePartons_py", &_lhePartons_py);
    tree_new->Branch("lhePartons_pz", &_lhePartons_pz);
    tree_new->Branch("lhePartons_e", &_lhePartons_e);
    tree_new->Branch("lhePartons_PdgId", &_lhePartons_PdgId);
  ...
  if(JEC!=0 || TES!=0){
    ...
    tree_new->Branch("MC_weight",&_MC_weight);
  ...
  // Jet-to-lepton fake rate SFs --> MISSING
  // Giovanni / Ram -> to converge

  cout<<"Getting jet-to-lepton fake rate SFs"<<endl;
  TString fakelepSFfile;
  if(year==2016) fakelepSFfile = "fake_rate_weights/FR_lep_ttH_mva090_2017_CERN_2018May29.root";
  else if(year==2017) fakelepSFfile = "fake_rate_weights/FR_lep_ttH_mva090_2017_CERN_2018May29.root";
  else if(year==2018) fakelepSFfile = "fake_rate_weights/FR_lep_ttH_mva090_2017_CERN_2018May29.root";
  cout<<"File "<<fakelepSFfile<<endl;

  TFile* f_fakerate = TFile::Open(fakelepSFfile);
  ...
  // Jet-to-tau fake rate SFs --> MISSING
  // Christian / Karl

  cout<<"Getting jet-to-tau fake rate SFs"<<endl;
  TString faketauSFfile;
  if(year==2016) faketauSFfile = "fake_rate_weights/FR_tau_2017_v2.root";
  else if(year==2017) faketauSFfile = "fake_rate_weights/FR_tau_2017_v2.root";
  else if(year==2018) faketauSFfile = "fake_rate_weights/FR_tau_2017_v2.root";
  cout<<"File: "<<faketauSFfile<<endl;
 
  TFile* f_fakerate_tau = TFile::Open(faketauSFfile);
  ...
  // Lepton charge flip weights --> MISSING
  // Siddesh

  cout<<"Getting charge flip rates"<<endl;  
  TString chargeSFfile;
  if(year==2016) chargeSFfile = "charge_flip_weights/ElectronChargeMisIdRates_2017_2018Jun22.root";
  else if(year==2017) chargeSFfile = "charge_flip_weights/ElectronChargeMisIdRates_2017_2018Jun22.root";
  else if(year==2018) chargeSFfile = "charge_flip_weights/ElectronChargeMisIdRates_2017_2018Jun22.root"; 
  cout<<"File: "<<chargeSFfile<<endl;
  
  TFile* f_QFrate = TFile::Open(chargeSFfile);
  TH2F* h_QFrate_el = (TH2F*)f_QFrate->Get("eChargeMisIdRates");
  h_QFrate_el->SetDirectory(0);
  f_QFrate->Close();


  // b-Tag DeepJet SFs --> READY
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    _recomu_matchedGenPartIdx.clear();
    ...
    _recoele_matchedGenPartIdx.clear();
    ...
    _recolep_matchedGenPartIdx.clear();
    ...
    _recotauh_byVVVLooseDeepTau2017v2p1VSjet.clear();
    _recotauh_byVVLooseDeepTau2017v2p1VSjet.clear();
    _recotauh_byVLooseDeepTau2017v2p1VSjet.clear();
    _recotauh_byLooseDeepTau2017v2p1VSjet.clear();
    _recotauh_byMediumDeepTau2017v2p1VSjet.clear();
    _recotauh_byTightDeepTau2017v2p1VSjet.clear();
    _recotauh_byVTightDeepTau2017v2p1VSjet.clear();
    _recotauh_byVVTightDeepTau2017v2p1VSjet.clear();
    _recotauh_byVVVLooseDeepTau2017v2p1VSe.clear();
    _recotauh_byVVLooseDeepTau2017v2p1VSe.clear();
    _recotauh_byVLooseDeepTau2017v2p1VSe.clear();
    _recotauh_byLooseDeepTau2017v2p1VSe.clear();
    _recotauh_byMediumDeepTau2017v2p1VSe.clear();
    _recotauh_byTightDeepTau2017v2p1VSe.clear();
    _recotauh_byVTightDeepTau2017v2p1VSe.clear();
    _recotauh_byVVTightDeepTau2017v2p1VSe.clear();
    _recotauh_byVLooseDeepTau2017v2p1VSmu.clear();
    _recotauh_byLooseDeepTau2017v2p1VSmu.clear();
    _recotauh_byMediumDeepTau2017v2p1VSmu.clear();
    _recotauh_byTightDeepTau2017v2p1VSmu.clear();
    _recotauh_byDeepTau2017v2p1VSjetraw.clear();
    _recotauh_byDeepTau2017v2p1VSeraw.clear();
    _recotauh_byDeepTau2017v2p1VSmuraw.clear();
    ...
    _recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Up.clear();
    _recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Down.clear();
    _recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Up.clear();
    _recotauh_fakerate_byLooseIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Down.clear();        
    _recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Up.clear();
    _recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par1Down.clear();
    _recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Up.clear();
    _recotauh_fakerate_byMediumIsolationMVArun2v2017v2DBdR03oldDMwLT_par2Down.clear();
    ...
    _recoPFak8Jet_subjet1_e.clear();
    _recoPFak8Jet_subjet1_pt.clear();
    _recoPFak8Jet_subjet1_px.clear();
    _recoPFak8Jet_subjet1_py.clear();
    _recoPFak8Jet_subjet1_pz.clear();
    _recoPFak8Jet_subjet1_eta.clear();
    _recoPFak8Jet_subjet1_phi.clear();

    _recoPFak8Jet_subjet2_e.clear();
    _recoPFak8Jet_subjet2_pt.clear();
    _recoPFak8Jet_subjet2_px.clear();
    _recoPFak8Jet_subjet2_py.clear();
    _recoPFak8Jet_subjet2_pz.clear();
    _recoPFak8Jet_subjet2_eta.clear();
    _recoPFak8Jet_subjet2_phi.clear();
    ...
    _daughters_iseleNoIsoWP80 = 0;
    _daughters_iseleNoIsoWP90 = 0;
 
    _daughters_e = 0;
    _daughters_px = 0;
    _daughters_py = 0;
    _daughters_pz = 0;
    _daughters_matchedMaxPtJetIndex = 0;
    ...
    _daughters_byDeepTau2017v2p1VSjetraw = 0;
    _daughters_byDeepTau2017v2p1VSeraw = 0;
    _daughters_byDeepTau2017v2p1VSmuraw = 0;
    ...
    for(unsigned int i_daughter=0; i_daughter<(*_daughters_e).size(); i_daughter++){
      ...
      if( fabs(PDGId)==13 ){
        ...
        int matchedjetidx = (*_daughters_matchedMaxPtJetIndex)[i_daughter];
        ...
        if(daughter.Pt()>5 && fabs(daughter.Eta())<2.4 && fabs(dxy)<=0.05 && fabs(dz)<0.1 && miniRelIso_nanoAOD<0.4 && sip < 8 && looseID){
          ...
          lepMVA_jetDF = std::max(DeepJet_matchedjetidx,float(0.));
    ...
    for(unsigned int i_mu=0; i_mu<reco_mus.size(); i_mu++){
      ...
      _recomu_jetDeepJet.push_back( std::max(DeepJet_matchedjetidx,float(0.)) );
      ...
      _recomu_matchedJetIndex.push_back( (*_daughters_matchedMaxPtJetIndex)[i_daughter] );
      ...
      float DJ_mediumWP = -999;
      if(_year==2016) DJ_mediumWP = 0.3093;
      else if(_year==2017) DJ_mediumWP = 0.3033;
      else if(_year==2018) DJ_mediumWP = 0.2770;

      float jetRelIso = -999;
      if(_daughters_dR_closest_jet[i_daughter]<0.4) jetRelIso = (1/_recomu_jetPtRatio_nanoAOD[i_mu])-1;
      else jetRelIso = _recomu_combreliso04[i_mu];

      float jetpt = 0.9*_recomu_pt[i_mu]*(1+jetRelIso);
      float ptmin = 20;
      float ptmax = 45;
      float DJ_upcut = smoothBFlav(jetpt,ptmin,ptmax, _year);

      if(conept>10 && _recomu_leptonMVA[i_mu]>=0.85 && _recomu_jetDeepJet[i_mu]<DJ_mediumWP) 
        isfakeable=true; 

      else if(conept>10 && _recomu_leptonMVA[i_mu]<0.85 && jetRelIso<0.5 && _recomu_jetDeepJet[i_mu]<DJ_upcut && _recomu_jetDeepJet[i_mu]<DJ_mediumWP)
        isfakeable=true;
      ...
      if(isfakeable && _recomu_leptonMVA[i_mu]>=0.85 && mediumID) 
        ismvasel=true;
    ...
    for(unsigned int i_ele=0; i_ele<reco_eles.size(); i_ele++){
      ...
      _recoele_jetDeepJet.push_back( std::max(DeepJet_matchedjetidx,float(0.)) );
      ...
      _recoele_matchedJetIndex.push_back( (*_daughters_matchedMaxPtJetIndex)[i_daughter] );
      ...
      float jetRelIso = -999;
      if(_daughters_dR_closest_jet[i_daughter]<0.4) jetRelIso = (1/_recoele_jetPtRatio_nanoAOD[i_ele])-1;
      else jetRelIso = _recoele_PFRelIsoAll04_nanoAOD[i_ele];

      bool WP80 = (*_daughters_iseleNoIsoWP80)[i_daughter];

      if(conept>10 && eleIDcut && eleMissingLostHits==0 && passConversionVeto){

        if(_recoele_leptonMVA[i_ele]>0.8 && _recoele_jetDeepJet[i_ele]<DJ_mediumWP)
          isfakeable=true;  
        else if(_recoele_leptonMVA[i_ele]<=0.8 && jetRelIso<0.7 && WP80 && _recoele_jetDeepJet[i_ele]<DJ_mediumWP)
          isfakeable=true;
     ...
     iscutsel=true;
      ...
      bool ismvasel=false;
      if(isfakeable && _recoele_leptonMVA[i_ele]>0.8) 
        ismvasel=true;
    ...
    for(unsigned int i_lep=0; i_lep<reco_leptons.size(); i_lep++){
      ...
      if(pdg==13){
	      ...
	      _recolep_pt.push_back(_recomu_pt[i_mu]);
              _recolep_uncorr_pt.push_back(_recomu_pt[i_mu]);
        ...
        _recolep_fakerate_be2.push_back(_recomu_fakerate_be2[i_mu]);
	      ...
	      _recolep_pt.push_back(_recoele_corr_pt[i_ele]);
              _recolep_uncorr_pt.push_back(_recoele_pt[i_ele]);
    ...
    for(unsigned int i_daughter=0; i_daughter<(*_daughters_e).size(); i_daughter++){
      ...
      int byVVVLooseDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byVVVLooseDeepTau2017v2p1VSjet"])&1;
      int byVVLooseDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byVVLooseDeepTau2017v2p1VSjet"])&1;
      int byVLooseDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byVLooseDeepTau2017v2p1VSjet"])&1;
      int byLooseDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byLooseDeepTau2017v2p1VSjet"])&1;
      int byMediumDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byMediumDeepTau2017v2p1VSjet"])&1;
      int byTightDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byTightDeepTau2017v2p1VSjet"])&1;
      int byVTightDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byVTightDeepTau2017v2p1VSjet"])&1;
      int byVVTightDeepTau2017v2p1VSjet = ((*_tauID)[i_daughter]>>map_tauID["byVVTightDeepTau2017v2p1VSjet"])&1;

      int byVVVLooseDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byVVVLooseDeepTau2017v2p1VSe"])&1;
      int byVVLooseDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byVVLooseDeepTau2017v2p1VSe"])&1;
      int byVLooseDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byVLooseDeepTau2017v2p1VSe"])&1;
      int byLooseDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byLooseDeepTau2017v2p1VSe"])&1;
      int byMediumDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byMediumDeepTau2017v2p1VSe"])&1;
      int byTightDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byTightDeepTau2017v2p1VSe"])&1;
      int byVTightDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byVTightDeepTau2017v2p1VSe"])&1;
      int byVVTightDeepTau2017v2p1VSe = ((*_tauID)[i_daughter]>>map_tauID["byVVTightDeepTau2017v2p1VSe"])&1;

      int byVLooseDeepTau2017v2p1VSmu = ((*_tauID)[i_daughter]>>map_tauID["byVLooseDeepTau2017v2p1VSmu"])&1;
      int byLooseDeepTau2017v2p1VSmu = ((*_tauID)[i_daughter]>>map_tauID["byLooseDeepTau2017v2p1VSmu"])&1;
      int byMediumDeepTau2017v2p1VSmu = ((*_tauID)[i_daughter]>>map_tauID["byMediumDeepTau2017v2p1VSmu"])&1;
      int byTightDeepTau2017v2p1VSmu = ((*_tauID)[i_daughter]>>map_tauID["byTightDeepTau2017v2p1VSmu"])&1;

      int decayModeFindingOld = (*_daughters_decayModeFindingOldDMs)[i_daughter];
      int decayModeFindingNew = (*_daughters_decayModeFindingNewDMs)[i_daughter];
      ...
      iso_cut = byVVLooseDeepTau2017v2p1VSjet; 

      bool nomin_cut = fabs(PDGId)==15 && daughter.Pt()>20 && fabs(daughter.Eta())<2.3 && iso_cut && decayModeFindingNew>0.5 && abs(dxy)<=1000 && abs(dz)<=0.2;     
    ...
    for(unsigned int i_tauh=0; i_tauh<reco_taus.size(); i_tauh++){
      ...
      _recotauh_matchedJetIndex.push_back( (*_daughters_matchedMaxPtJetIndex)[i_daughter] );
      ...
      _recotauh_byVVVLooseDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVVVLooseDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byVVLooseDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVVLooseDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byVLooseDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVLooseDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byLooseDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byLooseDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byMediumDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byMediumDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byTightDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byTightDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byVTightDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVTightDeepTau2017v2p1VSjet"])&1 );
      _recotauh_byVVTightDeepTau2017v2p1VSjet.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVVTightDeepTau2017v2p1VSjet"])&1 );

      _recotauh_byVVVLooseDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVVVLooseDeepTau2017v2p1VSe"])&1 );
      _recotauh_byVVLooseDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVVLooseDeepTau2017v2p1VSe"])&1 );
      _recotauh_byVLooseDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVLooseDeepTau2017v2p1VSe"])&1 );
      _recotauh_byLooseDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byLooseDeepTau2017v2p1VSe"])&1 );
      _recotauh_byMediumDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byMediumDeepTau2017v2p1VSe"])&1 );
      _recotauh_byTightDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byTightDeepTau2017v2p1VSe"])&1 );
      _recotauh_byVTightDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVTightDeepTau2017v2p1VSe"])&1 );
      _recotauh_byVVTightDeepTau2017v2p1VSe.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVVTightDeepTau2017v2p1VSe"])&1 );

      _recotauh_byVLooseDeepTau2017v2p1VSmu.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVLooseDeepTau2017v2p1VSmu"])&1 );
      _recotauh_byLooseDeepTau2017v2p1VSmu.push_back( ((*_tauID)[i_daughter]>>map_tauID["byLooseDeepTau2017v2p1VSmu"])&1 );
      _recotauh_byMediumDeepTau2017v2p1VSmu.push_back( ((*_tauID)[i_daughter]>>map_tauID["byMediumDeepTau2017v2p1VSmu"])&1 );
      _recotauh_byTightDeepTau2017v2p1VSmu.push_back( ((*_tauID)[i_daughter]>>map_tauID["byTightDeepTau2017v2p1VSmu"])&1 );

      _recotauh_byDeepTau2017v2p1VSjetraw.push_back( (*_daughters_byDeepTau2017v2p1VSjetraw)[i_daughter] );
      _recotauh_byDeepTau2017v2p1VSeraw.push_back( (*_daughters_byDeepTau2017v2p1VSeraw)[i_daughter] );
      _recotauh_byDeepTau2017v2p1VSmuraw.push_back( (*_daughters_byDeepTau2017v2p1VSmuraw)[i_daughter] );
    ...
    for(unsigned int i_jet=0; i_jet<(*_ak8jets_e).size(); i_jet++){
      ...
      // ----> allocating subjets to jets //
      int nsubjets = (*_ak8jets_nsubjets)[i_jet];
      vector< pair<int,TLorentzVector> > reco_subjets;

      for(unsigned int i_subjet=0; i_subjet<(*_subjets_e).size(); i_subjet++){
        TLorentzVector subjet ( (*_subjets_px)[i_subjet] , (*_subjets_py)[i_subjet] , (*_subjets_pz)[i_subjet] , (*_subjets_e)[i_subjet] );
        unsigned int motherjet_idx = (*_subjets_ak8MotherIdx)[i_subjet];
        if(motherjet_idx==i_jet){
      ...
      vector<TLorentzVector> ak8jet_subjets; //****
      ak8jet_subjets.clear();
      for(unsigned int i = 0; i<reco_subjets.size(); i++) {
        TLorentzVector i_subjet = reco_subjets[i].second;
        ak8jet_subjets.push_back(i_subjet);
      }
      int ak8jet_nsubjets = ak8jet_subjets.size(); //****
      // <---- allocating subjets to jets //
      ...
      if(ak8jet.Pt()>100 && fabs(ak8jet.Eta())<2.4 && msoftdrop>50){
        ...
        for(int i_subjet=0; i_subjet<ak8jet_nsubjets; i_subjet++){
          TLorentzVector jet = ak8jet_subjets.at(i_subjet);
          for(unsigned int i_lep=0; i_lep<_recolep_pt.size(); i_lep++){
            TLorentzVector lep;
            lep.SetPtEtaPhiE(_recolep_pt[i_lep],_recolep_eta[i_lep],_recolep_phi[i_lep],_recolep_e[i_lep]);
            float dR_lep_jet=lep.DeltaR(jet);
        ...
        for(int i_subjet=0; i_subjet<ak8jet_nsubjets; i_subjet++){
          TLorentzVector jet = ak8jet_subjets.at(i_subjet);
          for(unsigned int i_tauh=0; i_tauh<_recotauh_pt.size(); i_tauh++){
            TLorentzVector tauh;
            tauh.SetPtEtaPhiE(_recotauh_pt[i_tauh],_recotauh_eta[i_tauh],_recotauh_phi[i_tauh],_recotauh_e[i_tauh]);
            float dR_tauh_jet=tauh.DeltaR(jet);
            //if(dR_tauh_jet<0.4 && _recotauh_byMediumIsolationMVArun2v2017v2DBoldDMwLT[i_tauh]>0.5){
            if(dR_tauh_jet<0.4 && _recotauh_byMediumDeepTau2017v2p1VSjet[i_tauh]>0.5){
              dR_veto=true;
              break;
            }
          }
        ...
        _recoPFak8Jet_e.push_back(ak8jet.E());
        _recoPFak8Jet_pt.push_back(ak8jet.Pt());
        _recoPFak8Jet_px.push_back(ak8jet.Px());
        _recoPFak8Jet_py.push_back(ak8jet.Py());
        _recoPFak8Jet_pz.push_back(ak8jet.Pz());
        _recoPFak8Jet_eta.push_back(ak8jet.Eta());
        _recoPFak8Jet_phi.push_back(ak8jet.Phi());
        _recoPFak8Jet_SoftDropMass.push_back((*_ak8jets_SoftDropMass)[i_jet]);
        _recoPFak8Jet_tau1.push_back((*_ak8jets_tau1)[i_jet]);
        _recoPFak8Jet_tau2.push_back((*_ak8jets_tau2)[i_jet]);
        _recoPFak8Jet_tau3.push_back((*_ak8jets_tau3)[i_jet]);
        _recoPFak8Jet_nsubjets.push_back(ak8jet_nsubjets);

        if(ak8jet_subjets.size()==2){

          _recoPFak8Jet_subjet1_e.push_back(ak8jet_subjets.at(0).E());
          _recoPFak8Jet_subjet1_pt.push_back(ak8jet_subjets.at(0).Pt());
          _recoPFak8Jet_subjet1_px.push_back(ak8jet_subjets.at(0).Px());
          _recoPFak8Jet_subjet1_py.push_back(ak8jet_subjets.at(0).Py());
          _recoPFak8Jet_subjet1_pz.push_back(ak8jet_subjets.at(0).Pz());
          _recoPFak8Jet_subjet1_eta.push_back(ak8jet_subjets.at(0).Eta());
          _recoPFak8Jet_subjet1_phi.push_back(ak8jet_subjets.at(0).Phi());

          _recoPFak8Jet_subjet2_e.push_back(ak8jet_subjets.at(1).E());
          _recoPFak8Jet_subjet2_pt.push_back(ak8jet_subjets.at(1).Pt());
          _recoPFak8Jet_subjet2_px.push_back(ak8jet_subjets.at(1).Px());
          _recoPFak8Jet_subjet2_py.push_back(ak8jet_subjets.at(1).Py());
          _recoPFak8Jet_subjet2_pz.push_back(ak8jet_subjets.at(1).Pz());
          _recoPFak8Jet_subjet2_eta.push_back(ak8jet_subjets.at(1).Eta());
          _recoPFak8Jet_subjet2_phi.push_back(ak8jet_subjets.at(1).Phi());
    ...
    _n_recoPFak8Jet = _recoPFak8Jet_e.size();
    ...
    for(unsigned int i_mu=0; i_mu<_recomu_pt.size(); i_mu++){
      TLorentzVector muon;
      muon.SetPtEtaPhiE(_recomu_pt[i_mu],_recomu_eta[i_mu],_recomu_phi[i_mu],_recomu_e[i_mu]);
      if(_recomu_isfakeable[i_mu]){ 
        HTmiss_tlv-=muon; 
      }
    }
    for(unsigned int i_ele=0; i_ele<reco_eles_corr.size(); i_ele++){
      TLorentzVector elec=reco_eles_corr[i_ele].second;
      if(_recoele_isfakeable[i_ele]){ 
        HTmiss_tlv-=elec; 
        }
    }
    for(unsigned int i_tau=0; i_tau<reco_taus.size(); i_tau++){
      ...
      if (_recotauh_byVVLooseDeepTau2017v2p1VSjet[i_tau]){ HTmiss_tlv-=tau; }
    }
    ...
    if(isMC){
      ...
      vector<int> _recopart_matchedGenPartIdx;
      _recopart_matchedGenPartIdx.clear();
      ...
      for(unsigned int i_mu=0; i_mu<reco_mus.size(); i_mu++){
        ...
        for(unsigned int i_gen=0; i_gen<(*_genpart_pdg).size();i_gen++){
          ...
          if (std::find(_recopart_matchedGenPartIdx.begin(), _recopart_matchedGenPartIdx.end(), i_gen) != _recopart_matchedGenPartIdx.end())
             continue;
        ...
        _recomu_isGenMatched.push_back(genmatch);
        _recomu_matchedGenPartIdx.push_back(matched_genpart_idx);
      ...
      for(unsigned int i_ele=0; i_ele<reco_eles.size(); i_ele++){
        ...
        _recoele_isGenMatched.push_back(genmatch);
        _recoele_matchedGenPartIdx.push_back(matched_genpart_idx);
        _recopart_matchedGenPartIdx.push_back(matched_genpart_idx);
	  ...
	  if( !( abs((*_genpart_pdg)[i_gen])==abs(_recolep_pdg[i_lep]) || abs((*_genpart_pdg)[i_gen])==22 )) continue;
        ...
        _recolep_isGenMatched.push_back(genmatch);
        _recolep_matchedGenPartIdx.push_back(matched_genpart_idx);
        _recopart_matchedGenPartIdx.push_back(matched_genpart_idx);
...
/*
void test16(){
  convert_tree("sync16",0,0,true,0,0,2016);
}

void test17(){
  convert_tree("sync17",0,0,true,0,0,2017);
}

void test18(){
  convert_tree("sync18",0,0,true,0,0,2018);
}*/
