...
void split_tree(TString filename_in, TString filename_out,
  ...
  //cout<<"PU file: "<<pu_file_name<<endl;
  ...
  tree->SetBranchAddress("min_mll",&_min_mll);
  ...
  TTree* tree_1l1tau_flip=tree->GetTree()->CloneTree(0);
  ...
  TTree* tree_3l_CR_SR=tree->GetTree()->CloneTree(0);
  TTree* tree_3l_CR_fake=tree->GetTree()->CloneTree(0);
  TTree* tree_4l_CR_SR=tree->GetTree()->CloneTree(0);
  TTree* tree_4l_CR_fake=tree->GetTree()->CloneTree(0);
  ...
  tree_1l1tau_flip->SetNameTitle("HTauTauTree_1l1tau_flip","HTauTauTree_1l1tau_flip");
  ...
  tree_3l_CR_SR->SetNameTitle("HTauTauTree_3l_CR_SR","HTauTauTree_3l_CR_SR");
  tree_3l_CR_fake->SetNameTitle("HTauTauTree_3l_CR_fake","HTauTauTree_3l_CR_fake");
  tree_4l_CR_SR->SetNameTitle("HTauTauTree_4l_CR_SR","HTauTauTree_4l_CR_SR");
  tree_4l_CR_fake->SetNameTitle("HTauTauTree_4l_CR_fake","HTauTauTree_3l_4R_fake");
  ...
  tree_new.push_back(tree_1l1tau_flip);
  ...
  tree_new.push_back(tree_3l_CR_SR);
  tree_new.push_back(tree_3l_CR_fake);
  tree_new.push_back(tree_4l_CR_SR);
  tree_new.push_back(tree_4l_CR_fake);
  ...
  int n_2lss1tau_SR_ttH = 0;
  int n_2lss1tau_SR_tH = 0;
  int n_2lss1tau_fake_ttH = 0;
  int n_2lss1tau_fake_tH = 0;
  int n_2lss1tau_flip_ttH = 0;
  int n_2lss1tau_flip_tH = 0;
  int n_2los1tau_SR = 0;
  ...
  */
  ...
  int _n_tight_WPVL_tau;
  int _n_tight_WPL_tau;
  int _n_tight_WPM_tau;
  int _n_tight_WPT_tau;
  int _n_tight_WPVT_tau;
  ...
  vector<int>   _recotauh_sel_decayModeFindingOldDMs;
  vector<int>   _recotauh_sel_decayModeFindingNewDMs;
  ...
  for(unsigned int i=0; i<tree_new.size();i++){
    ...
    tree_new[i]->Branch("n_tight_WPVL_tau",&_n_tight_WPVL_tau);
    tree_new[i]->Branch("n_tight_WPL_tau",&_n_tight_WPL_tau);
    tree_new[i]->Branch("n_tight_WPM_tau",&_n_tight_WPM_tau);
    tree_new[i]->Branch("n_tight_WPT_tau",&_n_tight_WPT_tau);
    tree_new[i]->Branch("n_tight_WPVT_tau",&_n_tight_WPVT_tau);
    ...
    tree_new[i]->Branch("recotauh_sel_byVVLooseDeepTau2017v2p1VSjet",&_recotauh_sel_byVVLooseDeepTau2017v2p1VSjet);
    tree_new[i]->Branch("recotauh_sel_byVLooseDeepTau2017v2p1VSjet",&_recotauh_sel_byVLooseDeepTau2017v2p1VSjet);
    tree_new[i]->Branch("recotauh_sel_byLooseDeepTau2017v2p1VSjet",&_recotauh_sel_byLooseDeepTau2017v2p1VSjet);
    tree_new[i]->Branch("recotauh_sel_byMediumDeepTau2017v2p1VSjet",&_recotauh_sel_byMediumDeepTau2017v2p1VSjet);
    ...
    tree_new[i]->Branch("PU_weight_v1",&_PU_weight_v1,"PU_weight_v1/F");
    tree_new[i]->Branch("npu",&_npu,"npu/F");
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    _recotauh_sel_byMediumDeepTau2017v2p1VSjet.clear();
    ...
    */
    ...
    for(int i_tau=0; i_tau<_n_fakeable_tau; i_tau++){
      ...
      if((*_recotauh_byVLooseDeepTau2017v2p1VSjet)[i_tau] > 0.5) _n_tight_WPVL_tau += 1;
      if((*_recotauh_byLooseDeepTau2017v2p1VSjet)[i_tau]  > 0.5) _n_tight_WPL_tau += 1;
      if((*_recotauh_byMediumDeepTau2017v2p1VSjet)[i_tau] > 0.5) _n_tight_WPM_tau += 1;
      if((*_recotauh_byTightDeepTau2017v2p1VSjet)[i_tau]  > 0.5) _n_tight_WPT_tau += 1;
      if((*_recotauh_byVTightDeepTau2017v2p1VSjet)[i_tau] > 0.5) _n_tight_WPVT_tau += 1;
    ...
    //bool inv_mass_lep_pairs=true; //with electron cleaning
    bool inv_mass_lep_pairs = (_min_mll>12); //without electron cleaning
    ...
    bool sig_2tau_SR = 
      sig_2tau_base &&
      ((*_recotauh_byLooseDeepTau2017v2p1VSjet)[0]>0.5 && (*_recotauh_byLooseDeepTau2017v2p1VSjet)[1]>0.5);
    ...
    bool sig_1l1tau_fake = 
      sig_1l1tau_base &&
      ( !(_recolep_fakeable_ismvasel[0]) || !((*_recotauh_byMediumDeepTau2017v2p1VSjet)[0]>0.5) ) &&
      genchargematch_1l1tau;
    ...
    bool sig_1l2tau_SR = 
      ...
      ((*_recotauh_byMediumDeepTau2017v2p1VSjet)[0]>0.5 && (*_recotauh_byMediumDeepTau2017v2p1VSjet)[1]>0.5) &&
      (((*_recotauh_charge)[0]*(*_recotauh_charge)[1])<0) &&
    ...
    bool sig_1l2tau_fake = 
      sig_1l2tau_base &&
      (_n_recoPFJet>=3 && (_n_recoPFJet_btag_medium>=1 || _n_recoPFJet_btag_loose>=2) ) &&
      ( !(_recolep_fakeable_ismvasel[0]==1) || !((*_recotauh_byMediumDeepTau2017v2p1VSjet)[0]>0.5 && (*_recotauh_byMediumDeepTau2017v2p1VSjet)[1]>0.5) ) &&        
      ( ((*_recotauh_charge)[0]*(*_recotauh_charge)[1])<0 );
    ...
    bool is_2l1tau_ttH_like = pass_njet_2l1tau_ttH;
    bool is_2l1tau_tH_like_and_not_ttH_like = pass_njet_2l1tau_tH && !pass_njet_2l1tau_ttH;

    bool sig_2lss1tau_SR =
      sig_2lss1tau_base &&
      ((_recolep_fakeable_charge[0]*_recolep_fakeable_charge[1])>0) &&
      (_recolep_fakeable_ismvasel[0] && _recolep_fakeable_ismvasel[1]) &&
      (_n_tight_WPVL_tau>=1) && (*_recotauh_byVLooseDeepTau2017v2p1VSjet)[0] &&
      ((_recolep_fakeable_charge[0]*(*_recotauh_charge)[0])<0);

    bool sig_2lss1tau_SR_ttH =
      sig_2lss1tau_SR &&
      pass_njet_2l1tau_ttH;

    bool sig_2lss1tau_SR_tH =
      sig_2lss1tau_SR &&
      pass_njet_2l1tau_tH && !pass_njet_2l1tau_ttH;
    ...
    bool sig_2lss1tau_fake_ttH =
      sig_2lss1tau_fake &&
      pass_njet_2l1tau_ttH;

    bool sig_2lss1tau_fake_tH =
      sig_2lss1tau_fake &&
      pass_njet_2l1tau_tH && !pass_njet_2l1tau_ttH;
    ...
    bool sig_2lss1tau_flip_ttH =
      sig_2lss1tau_flip &&
      pass_njet_2l1tau_ttH;

    bool sig_2lss1tau_flip_tH =
      sig_2lss1tau_flip &&
      pass_njet_2l1tau_tH && !pass_njet_2l1tau_ttH; 
    ...
    bool sig_2los1tau_SR =
      ...
      ((_recolep_fakeable_charge[0]*_recolep_fakeable_charge[1])<0) &&
      (_recolep_fakeable_ismvasel[0] && _recolep_fakeable_ismvasel[1]) &&
      (_n_tight_WPVT_tau>=1) && ((*_recotauh_byVTightDeepTau2017v2p1VSjet)[0]>0.5);

    bool sig_2los1tau_fake =
      sig_2los1tau_base &&
      ( !(_recolep_fakeable_ismvasel[0] && _recolep_fakeable_ismvasel[1]) || !((*_recotauh_byVTightDeepTau2017v2p1VSjet)[0]>0.5) );
    ...
    bool sig_2l2tau_SR =
      sig_2l2tau_base &&
      (_recolep_fakeable_ismvasel[0] && _recolep_fakeable_ismvasel[1]) &&
      ((*_recotauh_byMediumDeepTau2017v2p1VSjet)[0] && (*_recotauh_byMediumDeepTau2017v2p1VSjet)[1] );

    bool sig_2l2tau_fake =
      sig_2l2tau_base &&
      (!(_recolep_fakeable_ismvasel[0] && _recolep_fakeable_ismvasel[1]) || !((*_recotauh_byMediumDeepTau2017v2p1VSjet)[0] && (*_recotauh_byMediumDeepTau2017v2p1VSjet)[1] ));
    ...
    bool sig_3l_CR_base = passTriggers_3lep0tau &&
      (_n_fakeable_lep>=3) &&
      (_recolep_fakeable_conept[0]>25 && _recolep_fakeable_conept[1]>15 && _recolep_fakeable_conept[2]>10) &&
      inv_mass_lep_pairs &&
      !inv_mass_Z_SFOS &&
    ...
    bool sig_4l_CR_base = passTriggers_3lep0tau &&
      (_n_fakeable_lep>=4) &&
      (_recolep_fakeable_conept[0]>25 && _recolep_fakeable_conept[1]>15 && _recolep_fakeable_conept[2]>15 && _recolep_fakeable_conept[3]>10) &&
      inv_mass_lep_pairs &&
      !inv_mass_Z_SFOS &&
    ...
    if (sig_2tau_SR) {
      ...
      for(int i_tau = 0; i_tau<2; i_tau++){
        ...
        _recotauh_sel_byMediumDeepTau2017v2p1VSjet.push_back((*_recotauh_byMediumDeepTau2017v2p1VSjet)[i_tau]);
      ...
      /*_triggerSF_weight = triggerSF_ditau(_recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           _year, 0);

      close_triggerSF_files();

      _triggerSF_weight_up = triggerSF_ditau(_recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           _year, +1);

      close_triggerSF_files();

      _triggerSF_weight_down = triggerSF_ditau(_recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           _year, -1);
    ...
    if(sig_1l1tau_SR){
      ...
      /*_triggerSF_weight = triggerSF_leptau(_recolep_sel_pt[0],_recolep_sel_eta[0],_recolep_sel_pdg[0],
                                           _recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           passHLT1l, passHLT1l1tau, _year,false, 0 );

      close_triggerSF_files();

      _triggerSF_weight_up = triggerSF_leptau(_recolep_sel_pt[0],_recolep_sel_eta[0],_recolep_sel_pdg[0],
                                           _recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           passHLT1l, passHLT1l1tau, _year,false, +1 );

      close_triggerSF_files();

      _triggerSF_weight_down = triggerSF_leptau(_recolep_sel_pt[0],_recolep_sel_eta[0],_recolep_sel_pdg[0],
                                           _recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           passHLT1l, passHLT1l1tau, _year,false, -1 );
      ...
      if(_recolep_sel_ismvasel[0])
        _leptonSF_ttH_weight = leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],3); //nlep==3 no tight charge requirement     
      else
        _leptonSF_ttH_weight = _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],3,0);
    ...
    if (sig_1l2tau_SR) {
      ...
      /*_triggerSF_weight = triggerSF_leptau(_recolep_sel_pt[0],_recolep_sel_eta[0],_recolep_sel_pdg[0],
                                           _recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           passHLT1l, passHLT1l1tau, _year, true, 0);
      ...
      _triggerSF_weight_up = triggerSF_leptau(_recolep_sel_pt[0],_recolep_sel_eta[0],_recolep_sel_pdg[0],
                                           _recotauh_sel_pt[0],_recotauh_sel_eta[0],_recotauh_sel_phi[0],_recotauh_sel_decayMode[0],
                                           _recotauh_sel_pt[1],_recotauh_sel_eta[1],_recotauh_sel_phi[1],_recotauh_sel_decayMode[1],
                                           passHLT1l, passHLT1l1tau, _year, true, +1);
    ...
    if (sig_2lss_SR_ttH || sig_2lss_SR_tH) {
      ...
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],2,0,_year);
      _triggerSF_weight_up = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],2,+1,_year);
      _triggerSF_weight_down = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],2,-1,_year);

      if(_recolep_sel_ismvasel[0])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],2); //nlep==2 tight charge requirement
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],2,0);

      if(_recolep_sel_ismvasel[1])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[1],_recolep_sel_pt[1],_recolep_sel_eta[1],2);
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[1],_recolep_sel_pt[1],_recolep_sel_eta[1],2,0);
    ...
    if (sig_2lss1tau_SR_ttH || sig_2lss1tau_SR_tH) {
      ...
      if (sig_2lss1tau_SR_ttH) n_2lss1tau_SR_ttH += 1;
      if (sig_2lss1tau_SR_tH)  n_2lss1tau_SR_tH += 1;

      _is_ttH_like = sig_2lss1tau_SR_ttH;
      _is_tH_like_and_not_ttH_like = sig_2lss1tau_SR_tH;
    ...
    if (sig_2los1tau_SR) {
      ...
      if(_recolep_sel_ismvasel[0])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],3); //no tight charge requirement
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],3,0);

      if(_recolep_sel_ismvasel[1])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[1],_recolep_sel_pt[1],_recolep_sel_eta[1],3);
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[1],_recolep_sel_pt[1],_recolep_sel_eta[1],3,0);
    ...
    if (sig_3l_SR_ttH || sig_3l_SR_tH) {
      ...
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],3,0,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],3,+1,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],3,-1,_year);
      ...
      if(_recolep_sel_ismvasel[2])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[2],_recolep_sel_pt[2],_recolep_sel_eta[2],3);
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[2],_recolep_sel_pt[2],_recolep_sel_eta[2],3,0);
    ...
    if (sig_4l_SR) {
      ...
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],4,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],4,+1,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],4,-1,_year); 
      ...
      if(_recolep_sel_ismvasel[3])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[3],_recolep_sel_pt[3],_recolep_sel_eta[3],3);
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[3],_recolep_sel_pt[3],_recolep_sel_eta[3],3,0);
    ...
    if (sig_ZZ_CR_SR) {
      ...
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],4,0,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],4,+1,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],4,-1,_year);   
    ...
    if(sig_2lss_fake_ttH || sig_2lss_fake_tH){
      ...
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],2,0,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],2,+1,_year);
      _triggerSF_weight = triggerSF_leptonic(_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_pdg[1],_recolep_sel_pt[1],2,-1,_year);  


      if(_recolep_sel_ismvasel[0])
        _leptonSF_ttH_weight *= leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],2); //nlep==3 no tight charge requirement
      else
        _leptonSF_ttH_weight *= _get_recoToLoose_leptonSF_ttH(_year,_recolep_sel_pdg[0],_recolep_sel_pt[0],_recolep_sel_eta[0],2,0); 
    ...
    if(sig_2lss1tau_fake_ttH || sig_2lss1tau_fake_tH){
      ...
      if (sig_2lss1tau_fake_ttH) n_2lss1tau_fake_ttH += 1;
      if (sig_2lss1tau_fake_tH)  n_2lss1tau_fake_tH += 1;

      _is_ttH_like = sig_2lss1tau_fake_ttH;
      _is_tH_like_and_not_ttH_like = sig_2lss1tau_fake_tH;
    ...
    if (sig_2lss1tau_flip_ttH || sig_2lss1tau_flip_tH) {
      ...
      if (sig_2lss1tau_flip_ttH) n_2lss1tau_flip_ttH += 1;
      if (sig_2lss1tau_flip_tH)  n_2lss1tau_flip_tH += 1;

      _is_ttH_like = sig_2lss1tau_flip_ttH;
      _is_tH_like_and_not_ttH_like = sig_2lss1tau_flip_tH;
  ...
  cout<<"1l1tau flip: "<<n_1l1tau_flip<<endl; 
  cout<<"1l2tau SR: "<<n_1l2tau_SR<<endl;  
  cout<<"1l2tau fake: "<<n_1l2tau_fake<<endl;
  cout<<"2lss1tau SR: "<<n_2lss1tau_SR_ttH<<"/"<<n_2lss1tau_SR_tH<<endl;
  cout<<"2lss1tau fake: "<<n_2lss1tau_fake_ttH<<"/"<<n_2lss1tau_fake_tH<<endl;
  cout<<"2lss1tau flip: "<<n_2lss1tau_flip_ttH<<"/"<<n_2lss1tau_flip_tH<<endl;
  ...
  cout<<"3l CR SR: "<<n_3l_CR_SR<<endl;
  cout<<"3l CR fake: "<<n_3l_CR_fake<<endl;
  cout<<"4l CR SR: "<<n_4l_CR_SR<<endl;
  cout<<"4l CR fake: "<<n_4l_CR_fake<<endl;
  cout<<" "<<endl;
...
void test17(){
  ...
  TString fin = "/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/2017/sync_ntuple_converted_ttHNonbb_2017_v20.root";
  TString fout = "/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_splitted/2017/sync_ntuple_splitted_ttHNonbb_2017_v20.root";
...
void test18(){
  ...
  TString fin = "/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_converted/2018/sync_ntuple_converted_ttHNonbb_2018_v19.root";
  TString fout = "/data_CMS/cms/mperez/ttH_Legacy/sync_ntuples/ntuples_splitted/2018/sync_ntuple_splitted_ttHNonbb_2018_v20.root";
